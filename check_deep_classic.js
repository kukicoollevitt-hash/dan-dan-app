const fs = require("fs");
const content = fs.readFileSync("/Users/dandan/Desktop/brainmoon_academy0326/public/BRAINUP/korlit/deep_classic_content.js", "utf8");

let okCount = 0;
let errorCount = 0;

for (let i = 1; i <= 40; i++) {
  const unit = "deep_classic_" + String(i).padStart(2, "0");
  ...
  const nextUnit = "deep_classic_" + String(i + 1).padStart(2, "0");
