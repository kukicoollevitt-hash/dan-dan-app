const fs = require("fs");
const content = fs.readFileSync("/Users/dandan/Desktop/brainmoon_academy0326/public/BRAINUP/social/deep_pol_content.js", "utf8");

let okCount = 0;
let errorCount = 0;

for (let i = 1; i <= 20; i++) {
  const unit = "deep_pol_" + String(i).padStart(2, "0");
  ...
  const nextUnit = "deep_pol_" + String(i + 1).padStart(2, "0");
