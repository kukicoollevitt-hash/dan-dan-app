const fs = require("fs");
const content = fs.readFileSync("/Users/dandan/Desktop/brainmoon_academy0326/public/BRAINUP/korlit/modern_content.js", "utf8");

for (let i = 1; i <= 40; i++) {
  const unit = "modern_" + String(i).padStart(2, "0");
