...
for (let i = 11; i <= 20; i++) {
  ...
  if (!modified && content.includes(oldPattern2)) {
    ...
    console.log(`[OK] classic_${num} 보완학습 버튼 활성화 (패턴2)`);
    modified = true;
  }
  ...
  if (!modified && content.includes('report-btn-remedial') && content.includes('style="display:none;"')) {
    ...
    console.log(`[OK] classic_${num} 보완학습 버튼 display:none 제거`);
    modified = true;
  }
