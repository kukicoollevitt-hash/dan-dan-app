const fs = require("fs");
const content = fs.readFileSync("/Users/dandan/Desktop/brainmoon_academy0326/public/BRAINUP/science/deep_bio_content.js", "utf8");

for (let i = 1; i <= 20; i++) {
  const unit = "deep_bio_" + String(i).padStart(2, "0");

  const passageStart = content.indexOf(unit + ":");
  if (passageStart === -1) continue;

  const nextUnit = "deep_bio_" + String(i + 1).padStart(2, "0");
