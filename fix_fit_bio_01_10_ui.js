...
for (let i = 1; i <= 10; i++) {
  ...
  if (content.includes(oldOpenPattern1)) {
    ...
    console.log(`[OK] fit_bio_${num} openRemedial 동그라미 번호 추가`);
    modified = true;
  }
  ...
  if (content.includes(oldGradePattern1)) {
    ...
    console.log(`[OK] fit_bio_${num} gradeRemedial selected 값 수정`);
    modified = true;
  }
  ...
  if (content.includes(oldCorrectPattern)) {
    ...
    console.log(`[OK] fit_bio_${num} gradeRemedial 정답 해설 추가`);
    modified = true;
  }
  ...
  if (content.includes(oldWrongPattern)) {
    ...
    console.log(`[OK] fit_bio_${num} gradeRemedial 오답 해설 추가`);
    modified = true;
  }
  ...
  if (modified) {
    ...
    console.log(`[SKIP] fit_bio_${num} 이미 수정되었거나 패턴 불일치`);
  }
}

console.log('\n✅ fit_bio_01~10 보완학습 UI 수정 완료!');
