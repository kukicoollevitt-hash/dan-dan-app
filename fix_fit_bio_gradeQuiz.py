#!/usr/bin/env python3
"""
fit_bio_01~20.html 파일의 gradeQuiz 함수에서
...
def main():
    ...
    print("fit_bio HTML 파일 gradeQuiz 함수 수정 시작...")

    for i in range(1, 21):
        unit_num = str(i).zfill(2)
        file_path = os.path.join(base_path, f"fit_bio_{unit_num}.html")
        print(f"\n📝 fit_bio_{unit_num}.html 처리 중...")
