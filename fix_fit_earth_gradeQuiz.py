#!/usr/bin/env python3
"""
fit_earth_01~20.html 파일의 gradeQuiz 함수에서
...
def main():
    ...
    print("fit_earth HTML 파일 gradeQuiz 함수 수정 시작...")

    for i in range(1, 21):
        unit_num = str(i).zfill(2)
        file_path = os.path.join(base_path, f"fit_earth_{unit_num}.html")
        print(f"\n📝 fit_earth_{unit_num}.html 처리 중...")
