...
function findFitFiles(dir) {
  ...
  for (const file of files) {
    ...
    if (stat.isDirectory()) {
      results = results.concat(findFitFiles(filePath));
    } else if (file.startsWith('fit_') && file.endsWith('.html')) {
...
const files = findFitFiles(brainupDir);

console.log(`Found ${files.length} fit_ HTML files\n`);
