#!/usr/bin/env python3
"""
on_people2_02~40.html 파일에 하이라이트 구조를 일괄 적용합니다.
"""
...
for i in range(2, 41):
    filename = f'on_people2_{i:02d}.html'
    ...
    if 'function clearEvidenceHighlights' not in content:
        # saveReadingProgress 함수 끝 다음에 추가
        ...
        if old_str in content:
            ...
            # 다른 패턴 시도
            old_str2 = "alert('저장 실패: ' + err.message);\n  }\n}\n</script>"
            new_str2 = "alert('저장 실패: ' + err.message);\n  }\n}" + highlight_functions + "</script>"
