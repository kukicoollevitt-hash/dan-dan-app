...
// soc_01~10 파일의 openRemedial 함수에서 optIdx 문제 수정
...
for (let i = 1; i <= 10; i++) {
  ...
  if (oldPattern.test(content)) {
    ...
    console.log(`[OK] soc_${num} openRemedial optIdx 수정`);
  } else {
    console.log(`[SKIP] soc_${num} 이미 수정되어 있음`);
  }

  fs.writeFileSync(filePath, content, 'utf8');
}

console.log('\n✅ soc_01~10 openRemedial optIdx 수정 완료!');
