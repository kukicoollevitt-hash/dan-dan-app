...
for (let i = 11; i <= 20; i++) {
  ...
  if (content.includes(oldOpenPattern1)) {
    ...
    console.log(`[OK] world2_${num} openRemedial 동그라미 번호 추가`);
    modified = true;
  }
  ...
  if (content.includes(oldGradePattern1)) {
    ...
    console.log(`[OK] world2_${num} gradeRemedial selected 값 수정`);
    modified = true;
  }
  ...
  if (content.includes(oldCorrectPattern)) {
    ...
    console.log(`[OK] world2_${num} gradeRemedial 정답 해설 추가`);
    modified = true;
  }
  ...
  if (content.includes(oldWrongPattern)) {
    ...
    console.log(`[OK] world2_${num} gradeRemedial 오답 해설 추가`);
    modified = true;
  }
