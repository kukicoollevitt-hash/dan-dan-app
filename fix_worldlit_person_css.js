...
.webtoon-dropdown.active { display: block; }
...
.webtoon-dropdown-header h4 { margin: 0; font-size: 14px; }
.webtoon-close-btn {
...
const folders = [
  { name: 'worldlit', prefixes: ['world1_', 'world2_'] },
  { name: 'person', prefixes: ['people1_', 'people2_'] }
];
