...
(function () {
  ...
  const ProgressManager = {
    ...
    markComplete() {
      ...
      const unit = detectUnit();                  // world1_04
      const key  = buildProgressKey(stu, unit);   // dan-progress:학생키:world1_04
...
window.sendLearningLog = async function () {
  try {
    const unit = window.CUR_UNIT || 'world1_02';
