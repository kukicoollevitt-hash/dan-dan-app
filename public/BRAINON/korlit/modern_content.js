/**
 * ✅ 단원 자동 인식 (강화)
 * 우선순위: ?unit=modern_XX → 파일명 modern_XX.html → 제목 숫자
 */
(function () {
...
window.CONTENTS = Object.assign(window.CONTENTS, {
  /* ===== modern_01 : “현대문학를 통해 세상을 이해하다” ===== */
  modern_01: {
    labelNo: '01',
    title: '🗺️ 현대문학를 통해 세상을 이해하다',
    passage: [
      '우리가 낯선 곳을 가거나 여행을 떠날 때 가장 먼저 확인하는 것은 현대문학예요. 현대문학는 단순히 길을 찾는 도구가 아니라, 세상의 구조와 사람들의 삶을 한눈에 볼 수 있게 해 주는 정보의 그림이에요. 현대문학 속에는 산의 높이와 모양, 강의 흐름, 도로와 건물의 위치가 표시되어 있어요. 그래서 현대문학만 봐도 그 지역의 <b>문학적 특징</b>과 생활 환경을 짐작할 수 있지요.',
      '현대문학는 목적에 따라 여러 종류로 나뉘어요. 산과 강, 도시와 나라의 경계를 보여주는 <b>일반도</b>가 있고, 특정한 정보를 중심으로 만든 <b>주제도</b>가 있어요. 예를 들어 관광 현대문학는 여행지를 안내하고, 교통 현대문학는 도로망이나 지하철 노선을 보여 줍니다. 또, <b>기후도</b>나 <b>인구 분포도</b>처럼 한 가지 주제를 깊이 다루는 현대문학도 있지요.',
      '요즘은 종이 현대문학 대신 <b>디지털 현대문학</b>를 자주 사용합니다. 스마트폰이나 자동차 <b>내비게이션</b>을 통해 <b>실시간</b>으로 길을 안내받을 수 있지요. 현대문학는 이제 단순한 종이 한 장이 아니라, 세상을 연결하는 디지털 창이 되었습니다. 현대문학를 잘 읽는 사람은 길을 아는 사람을 넘어, 세상을 이해하는 사람입니다.'
    ],
    vocab: [
      ['현대문학','땅 위의 여러 장소의 위치와 모습을 그림이나 기호로 나타낸 것.'],
      ['문학적 특징','자연/인문환경의 고유 성격.'],
      ['일반도','지형과 경계를 중심으로 표현한 현대문학.'],
      ['주제도','특정 주제를 중심으로 만든 현대문학.'],
      ['기후도','기온·강수량 등 기후 특성 현대문학.'],
      ['인구 분포도','인구 밀도/구조 시각화 현대문학.'],
      ['디지털 현대문학','전자기기에서 보는 현대문학.'],
      ['내비게이션','경로 안내 장치.'],
      ['실시간','지연 없이 즉시.']
    ],
    vocabFill: {
      instructions: '',
      items: [
        { no: 1, text: '현대문학는 땅 위의 여러 장소의 위치와 모습을 그림이나 기호로 나타낸 (      ) 예요.', answer: '현대문학', initials: 'ㅈㄷ', aliases: ['현대문학'] },
        { no: 2, text: '현대문학만 잘 봐도 한 지역의 (           )과 생활 모습을 짐작할 수 있어요.', answer: '문학적 특징', initials: 'ㅈㄹㅈ ㅌㅈ', aliases: ['문학적특징'] },
        { no: 3, text: '산, 강, 도시, 국경처럼 전체 모습을 보여 주는 현대문학는 (      )라고 하고,', answer: '일반도', initials: 'ㅇㅂㄷ', aliases: ['일반도'] },
        { no: 4, text: '교통, 인구, 기후 등 특정 주제를 중심으로 제작한 현대문학는 (      )라고 해요.', answer: '주제도', initials: 'ㅈㅈㄷ', aliases: ['주제도'] },
        { no: 5, text: '어떤 현대문학는 날씨를 보여 주기 위해 (      )를 사용하고,', answer: '기후도', initials: 'ㄱㅎㄷ', aliases: ['기후도'] },
        { no: 6, text: '어떤 현대문학는 사람들의 분포를 보여 주기 위해 (          )를 사용해요.', answer: '인구 분포도', initials: 'ㅇㄱ ㅂㅍㄷ', aliases: ['인구분포도'] },
        { no: 7, text: '요즘에는 스마트폰으로 보는 (          )와', answer: '디지털 현대문학', initials: 'ㄷㅈㅌ ㅈㄷ', aliases: ['디지털현대문학'] },
    ...
    quiz: {
      q1_text: '글쓴이가 현대문학를 ‘세상을 이해하는 도구’라고 표현한 이유로 가장 알맞은 것은 무엇인가요?',
      q1_opts: [
        '① 현대문학는 우리가 가야 할 길을 빠르게 안내해 주기 때문이다.',
        '② 현대문학에는 지역의 위치와 거리뿐 아니라 사람들의 생활 모습과 자연의 특징이 담겨 있기 때문이다.',
        '③ 현대문학는 기술의 발전으로 스마트폰에서 쉽게 사용할 수 있기 때문이다.',
        '④ 현대문학는 여행지의 관광 명소를 자세히 알려 주기 때문이다.'
      ],
      q2_text: '다음 중 ‘주제도’의 특징을 바르게 설명한 것은 무엇인가요?',
      q2_opts: [
        '① 자연환경을 중심으로 만든 현대문학이다.',
        '② 모든 지역의 정보를 한눈에 볼 수 있게 만든 현대문학이다.',
        '③ 교통, 인구, 기후 등 특정한 주제를 중심으로 제작된 현대문학이다.',
        '④ 현대문학 중 가장 오래된 형태로 나라의 경계를 표시한다.'
      ],
      q3_1_ph: 'ㄱㄱ', q3_2_ph: 'ㅇㅂㄷ',
      q4_1_ph: 'ㄷㅈㅌ', q4_2_ph: 'ㅅㅅㄱ',
      q5_text: '현대문학는 단순한 길 안내 도구를 넘어 세상을 이해하는 도구라고 했습니다. 이 말의 의미를 자신의 말로 설명해 보세요.'
    },
    answerKey: { q1:'2', q2:'3', q3_1:['경계'], q3_2:['일반도'], q4_1:['디지털','디지털현대문학','디지털 현대문학'], q4_2:['실시간'] },
    essayKeywords: ['현대문학','세상','이해','정보','삶','구조'],
    explain: {
      q1:'해설: 현대문학에는 생활/자연 정보가 담겨 세상을 이해하는 창이 됨.',
      q2:'해설: 주제도는 교통·관광·기후 등 한 주제를 중심으로 표현.',
      q3:'해설: 산과 강, 도시와 나라의 경계를 보여주는 현대문학는 일반도.',
      q4:'해설: 디지털 현대문학는 전자기기에서 실시간 정보 확인.',
      q5:'예시: 현대문학를 통해 구조·생활·자연환경을 함께 읽어낼 수 있음.현대문학에는 생활/자연 정보가 담겨 세상을 이해하는 창이 됨. 주제도는 교통·관광·기후 등 한 주제를 중심으로 표현. 등 '
    }
  },

  /* ===== modern_02 : “현대문학에 담긴 약속과 표현” ===== */
  modern_02: {
    labelNo: '02',
    title: '🗺️ 현대문학에 담긴 약속과 표현',
    passage: [
      '현대문학는 사람이 복잡한 공간을 이해하기 위해 만든 정보의 표현 도구이다. 현실의 땅을 그대로 그리면 복잡하고 알아보기 어려우므로, 사람들은 기호, 색채, 축척 등의 약속을 정해 땅의 모습을 단순하고 정확하게 표현한다.',
      '현대문학에는 산맥, 하천, 도로, 건물과 같은 요소가 <b>기호(symbol)</b>로 표시된다. 이 기호는 누구나 같은 의미로 이해할 수 있도록 정해진 약속이다. 예를 들어 학교는 모양 그림, 강은 파란색 선, 도로는 굵은 선으로 나타낸다.',
      '또 현대문학에는 <b>축척(scale)</b>이 표시되어 실제 거리와 현대문학 거리의 관계를 알려준다. ‘5만 분의 1 현대문학’는 실제 거리 5만 미터가 현대문학에서는 1미터로 나타난다는 뜻이다. 이 덕분에 사람들은 현대문학 위에서도 거리나 위치를 계산할 수 있다.',
      '지형의 높낮이는 <b>등고선(contour line)</b>과 색깔로 표현한다. 등고선 간격이 좁으면 경사가 급하고, 넓으면 완만하다. 색은 초록 → 노랑 → 갈색 → 고동색 순으로 낮은 곳에서 높은 곳으로 바뀌며 지형의 고도를 알려준다.',
      '마지막으로 <b>방위표(compass rose)</b>는 현대문학에서 동서남북의 방향을 알려주는 기준이다. 방위표가 없을 때는 위쪽이 북쪽, 오른쪽이 동쪽으로 간주한다.'
    ],
    vocab: [
      ['현대문학','공간의 모습을 기호, 색채, 축척으로 단순화한 표현'],
      ['기호(symbol)','사물/장소를 약속된 그림으로 나타낸 것'],
      ['축척(scale)','실제 거리와 현대문학 거리의 비율'],
      ['등고선(contour line)','같은 높이를 잇는 선'],
      ['방위표(compass rose)','현대문학의 방향을 알려주는 기준']
    ],
    /* ✅ 어휘학습(빈칸) */
    vocabFill: {
      instructions: '[현대문학 약속과 표현 어휘].',
      items: [
        { no: 1, text: '현실의 복잡한 공간을 단순화해 표현한 정보를 (      )라고 한다. ', answer: '현대문학', initials: 'ㅈㄷ', aliases: ['현대문학'] },
        { no: 2, text: '산맥·하천·도로·건물 등을 약속된 표시로 나타낸 것을 (      )라고 한다. ', answer: '기호', initials: 'ㄱㅎ', aliases: ['기호','symbol','심벌'] },
        { no: 3, text: '실제 거리와 현대문학 거리의 관계를 나타내는 약속은 (      )이다. ', answer: '축척', initials: 'ㅊㅊ', aliases: ['축척','scale'] },
        { no: 4, text: '같은 높이를 연결한 선으로 지형의 고도를 나타내는 것은 (      )이다. ', answer: '등고선', initials: 'ㄷㄱㅅ', aliases: ['등고선','contour line','컨투어'] },
        { no: 5, text: '현대문학에서 동서남북의 방향을 알려 주는 기준은 (      )이다. ', answer: '방위표', initials: 'ㅂㅇㅍ', aliases: ['방위표','compass rose'] },
        ...
        { no: 8, text: '“5만 분의 1”은 실제 5만 m가 현대문학에서 (      ) m로 나타난다는 뜻이다.', answer: '1', initials: '숫자', aliases: ['1','일'] }
      ]
    },
    quiz: {
      q1_text: '현대문학에서 산, 강, 도로, 건물 등 다양한 지형 요소를 약속된 표시로 나타낸 것에 대한 설명으로 가장 알맞은 것은 무엇인가요?',
      q1_opts: [
        '① 현대문학의 기호는 색깔 대신 그림을 이용해 지형을 예쁘게 꾸미는 것을 말한다.',
        '② 현대문학의 기호는 사람마다 다르게 사용할 수 있는 개인적인 약속을 의미한다.',
        '③ 현대문학의 기호는 산, 강, 도로, 건물 등을 일정한 약속에 따라 단순화하여 표시한 것이다.',
        '④ 현대문학의 기호는 실제 사진처럼 자세히 그려서 현실의 모습을 그대로 보여 주는 것이다.'
      ],
      q2_text: '다음 중 현대문학에서 높낮이의 차이를 표현하는 방법으로 가장 적절한 것은 무엇인가요?',
      q2_opts: [
        '① 현대문학에 글씨 크기를 다르게 써서 높은 지역을 표시한다.',
        '② 색깔과 등고선을 이용해 지형의 고도를 시각적으로 표현한다.',
        '③ 축척을 크게 하여 높은 곳과 낮은 곳의 거리를 계산한다.',
        '④ 방향표를 이용하여 높은 곳과 낮은 곳의 방향을 구분한다.'
      ],
      q3_html: `현대문학에는 실제 거리와 현대문학상의 거리를 일정한
    ...
    explain: {
      q1:'해설: 현대문학 기호는 지형 요소를 약속에 따라 단순화해 표시.',
      q2:'해설: 높낮이는 등고선과 색으로 표현.',
      q3:'해설: 실제/현대문학 거리의 관계=축척, 성격=비율.',
      q4:'해설: 방향을 알려주는 표식=방위표.',
      q5:'예시: 간격 좁음=급경사, 넓음=완경사.'
    }
  },

  /* ===== modern_03 : “우리 고장의 상징과 유래” ===== */
  modern_03: {
    labelNo: '03',
    ...
    passage: [
      ...
      '고장을 <b>탐방</b>할 때 현대문학를 활용하면 주요 장소의 위치를 쉽게 파악할 수 있다. 현대문학 속 정보를 실제 모습과 비교해 보면 우리 지역의 구조와 특징을 더 정확히 이해할 수 있다. 현대문학는 단순히 길을 찾는 도구가 아니라 공간의 질서를 이해하게 하는 시각적 약속이다.',
    ...
    vocabFill: {
      ...
      items: [
        ...
        { no: 7, text: '현대문학를 활용하면 지역의 구조와 특징을 더 정확히 (      ) 수 있다.', answer: '이해할', initials: 'ㅇㅎㅎ', aliases: ['이해하다','이해할 수'] }
      ]
    },
    quiz: {
  ...
  /* ===== modern_04 : “현대문학의 좌표와 경위도” ===== */
  modern_04: {
    labelNo: '04',
    title: '🧭 현대문학의 좌표와 경위도',
    passage: [
      '현대문학의 위치를 정확하게 나타내기 위해 좌표 체계를 사용한다. 가장 널리 쓰이는 방식이 지구를 둘러싼 가상의 선인 <b>경선</b>과 <b>위선</b>이다.',
      ...
      '종이 현대문학에서는 격자(grid)나 눈금을 사용해 좌표를 읽고, 디지털 현대문학에서는 터치로 좌표를 복사하거나 검색창에 위도·경도를 입력해 위치를 찾을 수 있다.'
    ],
    vocab: [
      ...
      ['격자(grid)', '현대문학를 일정 간격으로 나눈 선들의 모음']
    ],
    /* ✅ 어휘학습(빈칸) */
    vocabFill: {
      ...
      items: [
        ...
        { no: 5, text: '현대문학를 일정 간격으로 나눈 선들의 모음을 (      )라고 한다.', answer: '격자', initials: 'ㄱㅈ', aliases: ['격자','grid'] },
  ...
  /* ===== modern_06 : "현대문학를 보고 길을 찾아가다" (샘플 데이터) ===== */
  modern_06: {
    labelNo: '06',
    title: '🗺️ 현대문학를 보고 길을 찾아가다',
    passage: [
      '낯선 장소에 갔을 때 가장 먼저 하는 일은 현대문학를 확인하는 것입니다. 현대문학는 <b>방향</b>과 <b>거리</b>를 알려주어 목적지까지 안전하게 도달할 수 있게 합니다.',
      '현대문학를 읽을 때는 <b>축척</b>, <b>방위표</b>, <b>범례</b> 등을 이해해야 합니다. 이러한 정보를 활용하면 실제 공간에서 길을 찾는 데 큰 도움이 됩니다.',
      '요즘은 스마트폰의 <b>GPS</b> 기능으로 실시간 위치를 확인하며 길을 찾을 수 있지만, 종이 현대문학를 읽는 능력도 여전히 중요합니다.'
    ],
    vocab: [
      ['방향','동서남북 등 나아가는 쪽'],
      ['거리','두 지점 사이의 길이'],
      ['축척','실제와 현대문학의 크기 비율'],
      ['방위표','현대문학에서 방향을 나타내는 표시'],
      ['범례','현대문학 기호의 의미를 설명한 것'],
    ...
    vocabFill: {
      ...
      items: [
        ...
        { no: 3, text: '실제와 현대문학의 크기 비율을 (      )이라 한다.', answer: '축척', initials: 'ㅊㅊ', aliases: ['축척'] },
        { no: 4, text: '현대문학에서 방향을 나타내는 표시를 (      )라 한다.', answer: '방위표', initials: 'ㅂㅇㅍ', aliases: ['방위표'] },
        { no: 5, text: '현대문학 기호의 의미를 설명한 것을 (      )라 한다.', answer: '범례', initials: 'ㅂㄹ', aliases: ['범례'] },
    ...
    quiz: {
      q1_text: '현대문학를 읽을 때 가장 중요한 요소는 무엇인가요?',
      q1_opts: ['① 현대문학의 색깔', '② 축척, 방위표, 범례', '③ 현대문학의 크기', '④ 현대문학를 만든 사람'],
      ...
      q5_text: '종이 현대문학와 디지털 현대문학의 장단점을 비교하여 설명해 보세요.'
    },
    answerKey: { q1:'2', q2:'2', q3_1:['축척'], q3_2:['방위표'], q4_1:['GPS','지피에스'], q4_2:['실시간'] },
    essayKeywords: ['현대문학','종이','디지털','GPS','장점','단점'],
    explain: {
      q1:'해설: 축척, 방위표, 범례는 현대문학 읽기의 핵심 요소.',
      q2:'해설: GPS는 실시간 위치 확인이 가능함.',
      q3:'해설: 축척으로 거리를, 방위표로 방향을 알 수 있음.',
      q4:'해설: GPS는 실시간 위치 추적 가능.',
      q5:'예시: 종이 현대문학는 배터리 불필요, 디지털은 실시간 업데이트 가능.'
    }
  },

  /* ===== modern_07 : "세계 여러 나라의 위치와 특징" (샘플 데이터) ===== */
  modern_07: {
    labelNo: '07',
    ...
    passage: [
      ...
      '세계 현대문학를 통해 각 나라의 위치를 파악하고, 그 특징을 이해하는 것은 <b>국제 이해</b>의 첫걸음입니다.'
    ],
    vocab: [
    ...
    quiz: {
      ...
      q2_opts: ['① 다른 나라를 비판하기 위해', '② 여러 나라를 이해하고 존중하기 위해', '③ 우리나라만 발전시키기 위해', '④ 세계 현대문학를 외우기 위해'],
  ...
  /* ===== modern_08 : "우리나라의 문학적 특성 이해하기" (샘플 데이터) ===== */
  modern_08: {
    labelNo: '08',
  ...
  /* ===== modern_10 : "환경 문제와 지속 가능한 발전" (샘플 데이터) ===== */
  modern_10: {
    labelNo: '10',
  ...
  /* ===== modern_11 ~ modern_20 샘플 데이터 (더 간략하게) ===== */
...
window.CONTENTS = Object.assign(window.CONTENTS, {
  modern_21: {
    labelNo: '21',
    title: '📖 현대문학 21단원',
    passage: ['현대문학 21단원 내용입니다.','현대 작품을 통해 시대를 이해합니다.','다양한 주제와 기법을 학습합니다.'],
    vocab: [['현대문학','현대 글'],['작품','창작물'],['주제','중심'],['표현','나타냄'],['기법','방법'],['감상','느낌'],['분석','나눠봄'],['해석','풀이'],['비평','평가']],
    vocabFill: { instructions: '[현대문학 21]', items: [
      {no:1,text:'현대 글을 (     )이라 한다.',answer:'현대문학',initials:'ㅎㄷㅁㅎ',aliases:['현대문학']},
      {no:2,text:'창작물을 (   )이라 한다.',answer:'작품',initials:'ㅈㅍ',aliases:['작품']},
      {no:3,text:'중심을 (   )이라 한다.',answer:'주제',initials:'ㅈㅈ',aliases:['주제']},
      {no:4,text:'나타냄을 (   )이라 한다.',answer:'표현',initials:'ㅍㅎ',aliases:['표현']},
      {no:5,text:'방법을 (   )이라 한다.',answer:'기법',initials:'ㄱㅂ',aliases:['기법']},
      {no:6,text:'느낌을 (   )이라 한다.',answer:'감상',initials:'ㄱㅅ',aliases:['감상']},
      {no:7,text:'나눠봄을 (   )이라 한다.',answer:'분석',initials:'ㅂㅅ',aliases:['분석']},
      {no:8,text:'풀이를 (   )이라 한다.',answer:'해석',initials:'ㅎㅅ',aliases:['해석']},
      {no:9,text:'평가를 (   )이라 한다.',answer:'비평',initials:'ㅂㅍ',aliases:['비평']}
    ]},
    quiz: {q1_text:'현대문학의 특징은?',q1_opts:['① 시대 반영','② 무의미','③ 단순','④ 불필요'],q2_text:'작품 이해의 방법은?',q2_opts:['① 분석·감상','② 생략','③ 무시','④ 건너뛰기'],q3_1_ph:'ㅎㄷㅁㅎ',q3_2_ph:'ㅈㅍ',q4_1_ph:'ㅈㅈ',q4_2_ph:'ㅍㅎ',q5_text:'이 단원에서 배운 내용을 자신의 말로 설명해 보세요.'},
    answerKey: {q1:'1',q2:'1',q3_1:['현대문학'],q3_2:['작품'],q4_1:['주제'],q4_2:['표현']},
    essayKeywords: ['현대문학','작품','주제','표현','기법','감상'],
    explain: {q1:'해설: 현대문학은 시대를 반영.',q2:'해설: 분석과 감상이 중요.',q3:'해설: 현대문학과 작품.',q4:'해설: 주제와 표현.',q5:'예시: 현대문학의 가치, 작품 분석, 감상 방법.'}
  },

  modern_22: {
    labelNo: '22',
    title: '📖 현대문학 22단원',
    passage: ['현대문학 22단원 내용입니다.','현대 작품을 통해 시대를 이해합니다.','다양한 주제와 기법을 학습합니다.'],
    vocab: [['현대문학','현대 글'],['작품','창작물'],['주제','중심'],['표현','나타냄'],['기법','방법'],['감상','느낌'],['분석','나눠봄'],['해석','풀이'],['비평','평가']],
    vocabFill: { instructions: '[현대문학 22]', items: [
      {no:1,text:'현대 글을 (     )이라 한다.',answer:'현대문학',initials:'ㅎㄷㅁㅎ',aliases:['현대문학']},
      {no:2,text:'창작물을 (   )이라 한다.',answer:'작품',initials:'ㅈㅍ',aliases:['작품']},
      {no:3,text:'중심을 (   )이라 한다.',answer:'주제',initials:'ㅈㅈ',aliases:['주제']},
      {no:4,text:'나타냄을 (   )이라 한다.',answer:'표현',initials:'ㅍㅎ',aliases:['표현']},
  ...
  modern_23: {
    labelNo: '23',
    title: '📖 현대문학 23단원',
    passage: ['현대문학 23단원 내용입니다.','현대 작품을 통해 시대를 이해합니다.','다양한 주제와 기법을 학습합니다.'],
    vocab: [['현대문학','현대 글'],['작품','창작물'],['주제','중심'],['표현','나타냄'],['기법','방법'],['감상','느낌'],['분석','나눠봄'],['해석','풀이'],['비평','평가']],
    vocabFill: { instructions: '[현대문학 23]', items: [
      {no:1,text:'현대 글을 (     )이라 한다.',answer:'현대문학',initials:'ㅎㄷㅁㅎ',aliases:['현대문학']},
      {no:2,text:'창작물을 (   )이라 한다.',answer:'작품',initials:'ㅈㅍ',aliases:['작품']},
      {no:3,text:'중심을 (   )이라 한다.',answer:'주제',initials:'ㅈㅈ',aliases:['주제']},
      {no:4,text:'나타냄을 (   )이라 한다.',answer:'표현',initials:'ㅍㅎ',aliases:['표현']},
  ...
  modern_24: {
    labelNo: '24',
    title: '📖 현대문학 24단원',
    passage: ['현대문학 24단원 내용입니다.','현대 작품을 통해 시대를 이해합니다.','다양한 주제와 기법을 학습합니다.'],
    vocab: [['현대문학','현대 글'],['작품','창작물'],['주제','중심'],['표현','나타냄'],['기법','방법'],['감상','느낌'],['분석','나눠봄'],['해석','풀이'],['비평','평가']],
    vocabFill: { instructions: '[현대문학 24]', items: [
      {no:1,text:'현대 글을 (     )이라 한다.',answer:'현대문학',initials:'ㅎㄷㅁㅎ',aliases:['현대문학']},
      {no:2,text:'창작물을 (   )이라 한다.',answer:'작품',initials:'ㅈㅍ',aliases:['작품']},
      {no:3,text:'중심을 (   )이라 한다.',answer:'주제',initials:'ㅈㅈ',aliases:['주제']},
      {no:4,text:'나타냄을 (   )이라 한다.',answer:'표현',initials:'ㅍㅎ',aliases:['표현']},
  ...
  modern_25: {
    labelNo: '25',
    title: '📖 현대문학 25단원',
    passage: ['현대문학 25단원 내용입니다.','현대 작품을 통해 시대를 이해합니다.','다양한 주제와 기법을 학습합니다.'],
    vocab: [['현대문학','현대 글'],['작품','창작물'],['주제','중심'],['표현','나타냄'],['기법','방법'],['감상','느낌'],['분석','나눠봄'],['해석','풀이'],['비평','평가']],
    vocabFill: { instructions: '[현대문학 25]', items: [
      {no:1,text:'현대 글을 (     )이라 한다.',answer:'현대문학',initials:'ㅎㄷㅁㅎ',aliases:['현대문학']},
      {no:2,text:'창작물을 (   )이라 한다.',answer:'작품',initials:'ㅈㅍ',aliases:['작품']},
      {no:3,text:'중심을 (   )이라 한다.',answer:'주제',initials:'ㅈㅈ',aliases:['주제']},
      {no:4,text:'나타냄을 (   )이라 한다.',answer:'표현',initials:'ㅍㅎ',aliases:['표현']},
  ...
  modern_26: {
    labelNo: '26',
    title: '📖 현대문학 26단원',
    passage: ['현대문학 26단원 내용입니다.','현대 작품을 통해 시대를 이해합니다.','다양한 주제와 기법을 학습합니다.'],
    vocab: [['현대문학','현대 글'],['작품','창작물'],['주제','중심'],['표현','나타냄'],['기법','방법'],['감상','느낌'],['분석','나눠봄'],['해석','풀이'],['비평','평가']],
    vocabFill: { instructions: '[현대문학 26]', items: [
      {no:1,text:'현대 글을 (     )이라 한다.',answer:'현대문학',initials:'ㅎㄷㅁㅎ',aliases:['현대문학']},
      {no:2,text:'창작물을 (   )이라 한다.',answer:'작품',initials:'ㅈㅍ',aliases:['작품']},
      {no:3,text:'중심을 (   )이라 한다.',answer:'주제',initials:'ㅈㅈ',aliases:['주제']},
      {no:4,text:'나타냄을 (   )이라 한다.',answer:'표현',initials:'ㅍㅎ',aliases:['표현']},
  ...
  modern_27: {
    labelNo: '27',
    title: '📖 현대문학 27단원',
    passage: ['현대문학 27단원 내용입니다.','현대 작품을 통해 시대를 이해합니다.','다양한 주제와 기법을 학습합니다.'],
    vocab: [['현대문학','현대 글'],['작품','창작물'],['주제','중심'],['표현','나타냄'],['기법','방법'],['감상','느낌'],['분석','나눠봄'],['해석','풀이'],['비평','평가']],
    vocabFill: { instructions: '[현대문학 27]', items: [
      {no:1,text:'현대 글을 (     )이라 한다.',answer:'현대문학',initials:'ㅎㄷㅁㅎ',aliases:['현대문학']},
      {no:2,text:'창작물을 (   )이라 한다.',answer:'작품',initials:'ㅈㅍ',aliases:['작품']},
      {no:3,text:'중심을 (   )이라 한다.',answer:'주제',initials:'ㅈㅈ',aliases:['주제']},
      {no:4,text:'나타냄을 (   )이라 한다.',answer:'표현',initials:'ㅍㅎ',aliases:['표현']},
  ...
  modern_28: {
    labelNo: '28',
    title: '📖 현대문학 28단원',
    passage: ['현대문학 28단원 내용입니다.','현대 작품을 통해 시대를 이해합니다.','다양한 주제와 기법을 학습합니다.'],
    vocab: [['현대문학','현대 글'],['작품','창작물'],['주제','중심'],['표현','나타냄'],['기법','방법'],['감상','느낌'],['분석','나눠봄'],['해석','풀이'],['비평','평가']],
    vocabFill: { instructions: '[현대문학 28]', items: [
      {no:1,text:'현대 글을 (     )이라 한다.',answer:'현대문학',initials:'ㅎㄷㅁㅎ',aliases:['현대문학']},
      {no:2,text:'창작물을 (   )이라 한다.',answer:'작품',initials:'ㅈㅍ',aliases:['작품']},
      {no:3,text:'중심을 (   )이라 한다.',answer:'주제',initials:'ㅈㅈ',aliases:['주제']},
      {no:4,text:'나타냄을 (   )이라 한다.',answer:'표현',initials:'ㅍㅎ',aliases:['표현']},
  ...
  modern_29: {
    labelNo: '29',
    title: '📖 현대문학 29단원',
    passage: ['현대문학 29단원 내용입니다.','현대 작품을 통해 시대를 이해합니다.','다양한 주제와 기법을 학습합니다.'],
    vocab: [['현대문학','현대 글'],['작품','창작물'],['주제','중심'],['표현','나타냄'],['기법','방법'],['감상','느낌'],['분석','나눠봄'],['해석','풀이'],['비평','평가']],
    vocabFill: { instructions: '[현대문학 29]', items: [
      {no:1,text:'현대 글을 (     )이라 한다.',answer:'현대문학',initials:'ㅎㄷㅁㅎ',aliases:['현대문학']},
      {no:2,text:'창작물을 (   )이라 한다.',answer:'작품',initials:'ㅈㅍ',aliases:['작품']},
      {no:3,text:'중심을 (   )이라 한다.',answer:'주제',initials:'ㅈㅈ',aliases:['주제']},
      {no:4,text:'나타냄을 (   )이라 한다.',answer:'표현',initials:'ㅍㅎ',aliases:['표현']},
  ...
  modern_30: {
    labelNo: '30',
    title: '📖 현대문학 30단원',
    passage: ['현대문학 30단원 내용입니다.','현대 작품을 통해 시대를 이해합니다.','다양한 주제와 기법을 학습합니다.'],
    vocab: [['현대문학','현대 글'],['작품','창작물'],['주제','중심'],['표현','나타냄'],['기법','방법'],['감상','느낌'],['분석','나눠봄'],['해석','풀이'],['비평','평가']],
    vocabFill: { instructions: '[현대문학 30]', items: [
      {no:1,text:'현대 글을 (     )이라 한다.',answer:'현대문학',initials:'ㅎㄷㅁㅎ',aliases:['현대문학']},
      {no:2,text:'창작물을 (   )이라 한다.',answer:'작품',initials:'ㅈㅍ',aliases:['작품']},
      {no:3,text:'중심을 (   )이라 한다.',answer:'주제',initials:'ㅈㅈ',aliases:['주제']},
      {no:4,text:'나타냄을 (   )이라 한다.',answer:'표현',initials:'ㅍㅎ',aliases:['표현']},
  ...
  modern_31: {
    labelNo: '31',
    title: '📖 현대문학 31단원',
    passage: ['현대문학 31단원 내용입니다.','현대 작품을 통해 시대를 이해합니다.','다양한 주제와 기법을 학습합니다.'],
    vocab: [['현대문학','현대 글'],['작품','창작물'],['주제','중심'],['표현','나타냄'],['기법','방법'],['감상','느낌'],['분석','나눠봄'],['해석','풀이'],['비평','평가']],
    vocabFill: { instructions: '[현대문학 31]', items: [
      {no:1,text:'현대 글을 (     )이라 한다.',answer:'현대문학',initials:'ㅎㄷㅁㅎ',aliases:['현대문학']},
      {no:2,text:'창작물을 (   )이라 한다.',answer:'작품',initials:'ㅈㅍ',aliases:['작품']},
      {no:3,text:'중심을 (   )이라 한다.',answer:'주제',initials:'ㅈㅈ',aliases:['주제']},
      {no:4,text:'나타냄을 (   )이라 한다.',answer:'표현',initials:'ㅍㅎ',aliases:['표현']},
  ...
  modern_32: {
    labelNo: '32',
    title: '📖 현대문학 32단원',
    passage: ['현대문학 32단원 내용입니다.','현대 작품을 통해 시대를 이해합니다.','다양한 주제와 기법을 학습합니다.'],
    vocab: [['현대문학','현대 글'],['작품','창작물'],['주제','중심'],['표현','나타냄'],['기법','방법'],['감상','느낌'],['분석','나눠봄'],['해석','풀이'],['비평','평가']],
    vocabFill: { instructions: '[현대문학 32]', items: [
      {no:1,text:'현대 글을 (     )이라 한다.',answer:'현대문학',initials:'ㅎㄷㅁㅎ',aliases:['현대문학']},
      {no:2,text:'창작물을 (   )이라 한다.',answer:'작품',initials:'ㅈㅍ',aliases:['작품']},
      {no:3,text:'중심을 (   )이라 한다.',answer:'주제',initials:'ㅈㅈ',aliases:['주제']},
      {no:4,text:'나타냄을 (   )이라 한다.',answer:'표현',initials:'ㅍㅎ',aliases:['표현']},
  ...
  modern_33: {
    labelNo: '33',
    title: '📖 현대문학 33단원',
    passage: ['현대문학 33단원 내용입니다.','현대 작품을 통해 시대를 이해합니다.','다양한 주제와 기법을 학습합니다.'],
    vocab: [['현대문학','현대 글'],['작품','창작물'],['주제','중심'],['표현','나타냄'],['기법','방법'],['감상','느낌'],['분석','나눠봄'],['해석','풀이'],['비평','평가']],
    vocabFill: { instructions: '[현대문학 33]', items: [
      {no:1,text:'현대 글을 (     )이라 한다.',answer:'현대문학',initials:'ㅎㄷㅁㅎ',aliases:['현대문학']},
      {no:2,text:'창작물을 (   )이라 한다.',answer:'작품',initials:'ㅈㅍ',aliases:['작품']},
      {no:3,text:'중심을 (   )이라 한다.',answer:'주제',initials:'ㅈㅈ',aliases:['주제']},
      {no:4,text:'나타냄을 (   )이라 한다.',answer:'표현',initials:'ㅍㅎ',aliases:['표현']},
  ...
  modern_34: {
    labelNo: '34',
    title: '📖 현대문학 34단원',
    passage: ['현대문학 34단원 내용입니다.','현대 작품을 통해 시대를 이해합니다.','다양한 주제와 기법을 학습합니다.'],
    vocab: [['현대문학','현대 글'],['작품','창작물'],['주제','중심'],['표현','나타냄'],['기법','방법'],['감상','느낌'],['분석','나눠봄'],['해석','풀이'],['비평','평가']],
    vocabFill: { instructions: '[현대문학 34]', items: [
      {no:1,text:'현대 글을 (     )이라 한다.',answer:'현대문학',initials:'ㅎㄷㅁㅎ',aliases:['현대문학']},
      {no:2,text:'창작물을 (   )이라 한다.',answer:'작품',initials:'ㅈㅍ',aliases:['작품']},
      {no:3,text:'중심을 (   )이라 한다.',answer:'주제',initials:'ㅈㅈ',aliases:['주제']},
      {no:4,text:'나타냄을 (   )이라 한다.',answer:'표현',initials:'ㅍㅎ',aliases:['표현']},
  ...
  modern_35: {
    labelNo: '35',
    title: '📖 현대문학 35단원',
    passage: ['현대문학 35단원 내용입니다.','현대 작품을 통해 시대를 이해합니다.','다양한 주제와 기법을 학습합니다.'],
    vocab: [['현대문학','현대 글'],['작품','창작물'],['주제','중심'],['표현','나타냄'],['기법','방법'],['감상','느낌'],['분석','나눠봄'],['해석','풀이'],['비평','평가']],
    vocabFill: { instructions: '[현대문학 35]', items: [
      {no:1,text:'현대 글을 (     )이라 한다.',answer:'현대문학',initials:'ㅎㄷㅁㅎ',aliases:['현대문학']},
      {no:2,text:'창작물을 (   )이라 한다.',answer:'작품',initials:'ㅈㅍ',aliases:['작품']},
      {no:3,text:'중심을 (   )이라 한다.',answer:'주제',initials:'ㅈㅈ',aliases:['주제']},
      {no:4,text:'나타냄을 (   )이라 한다.',answer:'표현',initials:'ㅍㅎ',aliases:['표현']},
  ...
  modern_36: {
    labelNo: '36',
    title: '📖 현대문학 36단원',
    passage: ['현대문학 36단원 내용입니다.','현대 작품을 통해 시대를 이해합니다.','다양한 주제와 기법을 학습합니다.'],
    vocab: [['현대문학','현대 글'],['작품','창작물'],['주제','중심'],['표현','나타냄'],['기법','방법'],['감상','느낌'],['분석','나눠봄'],['해석','풀이'],['비평','평가']],
    vocabFill: { instructions: '[현대문학 36]', items: [
      {no:1,text:'현대 글을 (     )이라 한다.',answer:'현대문학',initials:'ㅎㄷㅁㅎ',aliases:['현대문학']},
      {no:2,text:'창작물을 (   )이라 한다.',answer:'작품',initials:'ㅈㅍ',aliases:['작품']},
      {no:3,text:'중심을 (   )이라 한다.',answer:'주제',initials:'ㅈㅈ',aliases:['주제']},
      {no:4,text:'나타냄을 (   )이라 한다.',answer:'표현',initials:'ㅍㅎ',aliases:['표현']},
  ...
  modern_37: {
    labelNo: '37',
    title: '📖 현대문학 37단원',
    passage: ['현대문학 37단원 내용입니다.','현대 작품을 통해 시대를 이해합니다.','다양한 주제와 기법을 학습합니다.'],
    vocab: [['현대문학','현대 글'],['작품','창작물'],['주제','중심'],['표현','나타냄'],['기법','방법'],['감상','느낌'],['분석','나눠봄'],['해석','풀이'],['비평','평가']],
    vocabFill: { instructions: '[현대문학 37]', items: [
      {no:1,text:'현대 글을 (     )이라 한다.',answer:'현대문학',initials:'ㅎㄷㅁㅎ',aliases:['현대문학']},
      {no:2,text:'창작물을 (   )이라 한다.',answer:'작품',initials:'ㅈㅍ',aliases:['작품']},
      {no:3,text:'중심을 (   )이라 한다.',answer:'주제',initials:'ㅈㅈ',aliases:['주제']},
      {no:4,text:'나타냄을 (   )이라 한다.',answer:'표현',initials:'ㅍㅎ',aliases:['표현']},
  ...
  modern_38: {
    labelNo: '38',
    title: '📖 현대문학 38단원',
    passage: ['현대문학 38단원 내용입니다.','현대 작품을 통해 시대를 이해합니다.','다양한 주제와 기법을 학습합니다.'],
    vocab: [['현대문학','현대 글'],['작품','창작물'],['주제','중심'],['표현','나타냄'],['기법','방법'],['감상','느낌'],['분석','나눠봄'],['해석','풀이'],['비평','평가']],
    vocabFill: { instructions: '[현대문학 38]', items: [
      {no:1,text:'현대 글을 (     )이라 한다.',answer:'현대문학',initials:'ㅎㄷㅁㅎ',aliases:['현대문학']},
      {no:2,text:'창작물을 (   )이라 한다.',answer:'작품',initials:'ㅈㅍ',aliases:['작품']},
      {no:3,text:'중심을 (   )이라 한다.',answer:'주제',initials:'ㅈㅈ',aliases:['주제']},
      {no:4,text:'나타냄을 (   )이라 한다.',answer:'표현',initials:'ㅍㅎ',aliases:['표현']},
  ...
  modern_39: {
    labelNo: '39',
    title: '📖 현대문학 39단원',
    passage: ['현대문학 39단원 내용입니다.','현대 작품을 통해 시대를 이해합니다.','다양한 주제와 기법을 학습합니다.'],
    vocab: [['현대문학','현대 글'],['작품','창작물'],['주제','중심'],['표현','나타냄'],['기법','방법'],['감상','느낌'],['분석','나눠봄'],['해석','풀이'],['비평','평가']],
    vocabFill: { instructions: '[현대문학 39]', items: [
      {no:1,text:'현대 글을 (     )이라 한다.',answer:'현대문학',initials:'ㅎㄷㅁㅎ',aliases:['현대문학']},
      {no:2,text:'창작물을 (   )이라 한다.',answer:'작품',initials:'ㅈㅍ',aliases:['작품']},
      {no:3,text:'중심을 (   )이라 한다.',answer:'주제',initials:'ㅈㅈ',aliases:['주제']},
      {no:4,text:'나타냄을 (   )이라 한다.',answer:'표현',initials:'ㅍㅎ',aliases:['표현']},
  ...
  modern_40: {
    labelNo: '40',
    title: '📖 현대문학 40단원',
    passage: ['현대문학 40단원 내용입니다.','현대 작품을 통해 시대를 이해합니다.','다양한 주제와 기법을 학습합니다.'],
    vocab: [['현대문학','현대 글'],['작품','창작물'],['주제','중심'],['표현','나타냄'],['기법','방법'],['감상','느낌'],['분석','나눠봄'],['해석','풀이'],['비평','평가']],
    vocabFill: { instructions: '[현대문학 40]', items: [
      {no:1,text:'현대 글을 (     )이라 한다.',answer:'현대문학',initials:'ㅎㄷㅁㅎ',aliases:['현대문학']},
      {no:2,text:'창작물을 (   )이라 한다.',answer:'작품',initials:'ㅈㅍ',aliases:['작품']},
      {no:3,text:'중심을 (   )이라 한다.',answer:'주제',initials:'ㅈㅈ',aliases:['주제']},
      {no:4,text:'나타냄을 (   )이라 한다.',answer:'표현',initials:'ㅍㅎ',aliases:['표현']},
