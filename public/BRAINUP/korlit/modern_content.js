...
window.CONTENTS = Object.assign(window.CONTENTS, {
  ...
  /* ===== modern_04 : "억울하게 잃어버린 논" ===== */
  modern_04: {
    labelNo: '04',
    title: '😢 억울하게 잃어버린 논',
    passage: [
      '구한말, 한덕문의 아버지 한태수는 새벽과 밤을 가리지 않고 일하는 근면한 농군이었어요. 그의 가족이 먹고살기 위해 마련한 열서너 마지기 논과 일곱 마지기 논은 온 가족의 피와 땀으로 지켜 온 삶의 터전이었죠. 하지만 어느 날, 한태수는 \'동학을 따랐다\'는 부당한 <b>누명</b>을 쓰고 <b>관아</b>에 끌려갔습니다. 거기서 사흘 동안 모진 심문을 받은 끝에, 결국 가진 논의 절반을 바치고 풀려날 수밖에 없었어요. 억울함은 컸지만 힘없는 농군에게 그 일을 되돌릴 방법은 없었습니다.',
      '세월이 지나며 조선 땅은 일제강점기에 접어들었습니다. 생활은 점점 더 팍팍해지고 세금과 <b>수탈</b>이 심해지면서 농민들은 삶을 지탱하기 어려웠죠. 이때 일본인 <b>지주</b> 길천이 농지를 높은 값에 사들인다는 소문이 돌았습니다. 한태수는 남아 있던 일곱 마지기를 팔아 당장의 위기를 넘기려 했지만, 마음속에서는 언젠가 다시 논을 찾을 수 있으리라는 희미한 기대가 남아 있었어요. 그러나 그 기대는 8·15 광복 이후 완전히 무너지게 됩니다. 나라가 독립되었지만 그의 삶은 오히려 더 복잡하고 혼란스러워졌기 때문이에요.',
      '광복 소식을 들은 한태수는 잃어버렸던 땅을 되찾을 수 있으리라 믿었습니다. 일본인 지주들이 떠났으니 과거의 <b>부당 처분</b>도 바로잡힐 것이라 생각했지요. 하지만 현실은 달랐습니다. <b>혼란기</b>를 틈타 <b>잇속</b>을 챙기려는 무리들이 일본인들의 땅을 자기 것으로 만들어 버린 겁니다. 그 와중에 한태수의 농토 역시 이미 다른 사람의 이름으로 넘어가 있었어요. 아무리 항의해도 소용이 없었습니다. 결국 그는 허탈한 얼굴로 "독립했다 할 때 만세 안 부르길 잘했지..."라고 중얼거리며, 되돌릴 수 없는 <b>상실감</b>을 삼켜야만 했습니다.'
    ],
    vocab: [
      ['누명', '사실이 아닌 죄를 뒤집어쓴 억울한 상황'],
      ['관아', '나라의 일을 처리하던 옛 관청'],
      ['수탈', '힘 있는 자가 약자의 재산을 강제로 빼앗는 일'],
      ['지주', '많은 땅을 가진 사람, 소작농에게 땅을 빌려줌'],
      ['부당 처분', '정당하지 않은 방식으로 재산이나 권리를 처리함'],
      ['혼란기', '질서가 무너지고 규칙이 제대로 작동하지 않는 시기'],
      ['잇속', '개인이 챙기는 이익이나 실리'],
      ['상실감', '소중한 것을 잃었을 때 느끼는 허전함과 슬픔']
    ],
    vocabFill: {
      instructions: '[억울하게 잃어버린 논 어휘]',
      items: [
        { no: 1, text: '사실이 아닌 죄를 뒤집어쓴 억울한 상황을 (      )이라 한다.', answer: '누명', initials: 'ㄴㅁ', aliases: ['누명'] },
        { no: 2, text: '나라의 일을 처리하던 옛 관청을 (      )라고 한다.', answer: '관아', initials: 'ㄱㅇ', aliases: ['관아'] },
        { no: 3, text: '힘 있는 자가 약자의 재산을 강제로 빼앗는 일을 (      )이라 한다.', answer: '수탈', initials: 'ㅅㅌ', aliases: ['수탈'] },
        { no: 4, text: '많은 땅을 가지고 소작농에게 땅을 빌려주는 사람을 (      )라고 한다.', answer: '지주', initials: 'ㅈㅈ', aliases: ['지주'] },
        { no: 5, text: '정당하지 않은 방식으로 재산이나 권리를 처리하는 것을 (        )이라 한다.', answer: '부당 처분', initials: 'ㅂㄷ ㅊㅂ', aliases: ['부당처분'] },
        { no: 6, text: '질서가 무너지고 규칙이 제대로 작동하지 않는 시기를 (      )라고 한다.', answer: '혼란기', initials: 'ㅎㄹㄱ', aliases: ['혼란기'] },
        { no: 7, text: '개인이 챙기는 이익이나 실리를 (      )이라 한다.', answer: '잇속', initials: 'ㅇㅅ', aliases: ['잇속'] },
        { no: 8, text: '소중한 것을 잃었을 때 느끼는 허전함과 슬픔을 (      )이라 한다.', answer: '상실감', initials: 'ㅅㅅㄱ', aliases: ['상실감'] }
      ]
    },
    quiz: {
      q1_text: '한태수가 논의 절반을 빼앗기게 된 직접적인 원인은 무엇인가요?',
      q1_opts: [
        '① 일본인 지주에게 땅을 팔았기 때문이다.',
        '② 세금을 내지 못해 나라에서 압수했기 때문이다.',
        '③ 동학을 따랐다는 누명을 쓰고 관아에 끌려갔기 때문이다.',
        '④ 광복 후 혼란기에 다른 사람이 빼앗아 갔기 때문이다.'
      ],
      q2_text: '이 글의 구조를 가장 바르게 설명한 것은 무엇인가요?',
      q2_opts: [
        '① 한태수의 하루 일과를 시간순으로 서술하고 있다.',
        '② 구한말 → 일제강점기 → 광복 후로 시대 순서에 따라 전개된다.',
        '③ 여러 인물의 관점을 번갈아 보여주는 다시점 구조이다.',
        '④ 결말을 먼저 제시하고 원인을 설명하는 역순행 구조이다.'
      ],
      q3_html: `한태수는 동학을 따랐다는 <input class="inline-input" id="q3-1" type="text" placeholder="ㄴㅁ">을 쓰고,
                <input class="inline-input" id="q3-2" type="text" placeholder="ㄱㅇ">에 끌려가 심문을 받았다.`,
      q4_html: `광복 후 <input class="inline-input" id="q4-1" type="text" placeholder="ㅎㄹㄱ">를 틈타 욕심 많은 무리들이
                <input class="inline-input" id="q4-2" type="text" placeholder="ㅇㅅ">을 챙기려고 남의 땅을 빼앗았다.`,
      q3_1_ph: 'ㄴㅁ', q3_2_ph: 'ㄱㅇ', q4_1_ph: 'ㅎㄹㄱ', q4_2_ph: 'ㅇㅅ',
      q5_text: '한태수가 "독립했다 할 때 만세 안 부르길 잘했지..."라고 말한 이유를 본문 내용을 바탕으로 설명해 보세요.'
    },
    answerKey: { q1:'3', q2:'2', q3_1:['누명'], q3_2:['관아'], q4_1:['혼란기'], q4_2:['잇속'] },
    essayKeywords: ['광복','독립','땅','되찾다','기대','무너지다','혼란','빼앗기다','상실감','허탈'],
    explain: {
      q1:'해설: 한태수는 동학을 따랐다는 누명을 쓰고 관아에 끌려가 논의 절반을 빼앗겼습니다.',
      q2:'해설: 이 글은 구한말 → 일제강점기 → 광복 후 순서로 시대에 따라 전개됩니다.',
      q3:'해설: 한태수는 누명을 쓰고 관아에 끌려가 심문을 받았습니다.',
      q4:'해설: 광복 후 혼란기를 틈타 욕심 많은 무리들이 잇속을 챙기려고 남의 땅을 빼앗았습니다.',
      q5:'예시: 한태수는 광복이 되면 땅을 되찾을 수 있을 거라 기대했지만, 오히려 혼란기에 다른 사람에게 땅을 빼앗겨 버렸기 때문에 독립을 기뻐할 수 없다는 허탈함을 표현한 것입니다.'
    },
    creative: {
      title: '역사 속 인물에게 편지 쓰기',
      topic: '한태수에게 위로와 응원의 편지를 써 보세요. 억울하게 땅을 잃은 그의 마음을 이해하고, 오늘날의 시각에서 전하고 싶은 말을 담아 보세요.',
      hint: '그 시대의 어려움, 농민의 삶, 정의롭지 못한 상황에 대한 공감을 표현해 보세요.',
      examples: [
        '예시 1) 한태수 할아버지, 평생 일군 땅을 빼앗기신 마음이 얼마나 억울하셨을지 짐작도 되지 않습니다.',
        '예시 2) 광복이 되었는데도 기쁘지 않으셨을 할아버지의 심정을 생각하니 마음이 아픕니다.',
        '예시 3) 지금은 그런 일이 없도록 법이 있으니, 할아버지 같은 분들이 없었으면 좋겠습니다.'
      ]
    }
  },
  ...
  /* ===== modern_06 : "지도를 보고 길을 찾아가다" (샘플 데이터) ===== */
  modern_06: {
    labelNo: '06',
  ...
  /* ===== modern_08 : "우리나라의 지리적 특성 이해하기" (샘플 데이터) ===== */
  modern_08: {
    labelNo: '08',
