...
window.CONTENTS = Object.assign(window.CONTENTS, {
  ...
  /* ===== people1_02 : “인물에 담긴 약속과 표현” ===== */
  people1_02: {
    labelNo: '02',
    title: '🗺️ 인물에 담긴 약속과 표현',
    passage: [
      '인물는 사람이 복잡한 공간을 이해하기 위해 만든 정보의 표현 도구이다. 현실의 땅을 그대로 그리면 복잡하고 알아보기 어려우므로, 사람들은 기호, 색채, 축척 등의 약속을 정해 땅의 모습을 단순하고 정확하게 표현한다.',
      '인물에는 산맥, 하천, 도로, 건물과 같은 요소가 <b>기호(symbol)</b>로 표시된다. 이 기호는 누구나 같은 의미로 이해할 수 있도록 정해진 약속이다. 예를 들어 학교는 모양 그림, 강은 파란색 선, 도로는 굵은 선으로 나타낸다.',
      '또 인물에는 <b>축척(scale)</b>이 표시되어 실제 거리와 인물 거리의 관계를 알려준다. ‘5만 분의 1 인물’는 실제 거리 5만 미터가 인물에서는 1미터로 나타난다는 뜻이다. 이 덕분에 사람들은 인물 위에서도 거리나 위치를 계산할 수 있다.',
      '지형의 높낮이는 <b>등고선(contour line)</b>과 색깔로 표현한다. 등고선 간격이 좁으면 경사가 급하고, 넓으면 완만하다. 색은 초록 → 노랑 → 갈색 → 고동색 순으로 낮은 곳에서 높은 곳으로 바뀌며 지형의 고도를 알려준다.',
      '마지막으로 <b>방위표(compass rose)</b>는 인물에서 동서남북의 방향을 알려주는 기준이다. 방위표가 없을 때는 위쪽이 북쪽, 오른쪽이 동쪽으로 간주한다.'
    ],
    vocab: [
      ['인물','공간의 모습을 기호, 색채, 축척으로 단순화한 표현'],
      ['기호(symbol)','사물/장소를 약속된 그림으로 나타낸 것'],
      ['축척(scale)','실제 거리와 인물 거리의 비율'],
      ['등고선(contour line)','같은 높이를 잇는 선'],
      ['방위표(compass rose)','인물의 방향을 알려주는 기준']
    ],
    /* ✅ 어휘학습(빈칸) */
    vocabFill: {
      instructions: '[인물 약속과 표현 어휘].',
      items: [
        { no: 1, text: '현실의 복잡한 공간을 단순화해 표현한 정보를 (      )라고 한다. ', answer: '인물', initials: 'ㅈㄷ', aliases: ['인물'] },
        { no: 2, text: '산맥·하천·도로·건물 등을 약속된 표시로 나타낸 것을 (      )라고 한다. ', answer: '기호', initials: 'ㄱㅎ', aliases: ['기호','symbol','심벌'] },
        { no: 3, text: '실제 거리와 인물 거리의 관계를 나타내는 약속은 (      )이다. ', answer: '축척', initials: 'ㅊㅊ', aliases: ['축척','scale'] },
        { no: 4, text: '같은 높이를 연결한 선으로 지형의 고도를 나타내는 것은 (      )이다. ', answer: '등고선', initials: 'ㄷㄱㅅ', aliases: ['등고선','contour line','컨투어'] },
        { no: 5, text: '인물에서 동서남북의 방향을 알려 주는 기준은 (      )이다. ', answer: '방위표', initials: 'ㅂㅇㅍ', aliases: ['방위표','compass rose'] },
        ...
        { no: 8, text: '“5만 분의 1”은 실제 5만 m가 인물에서 (      ) m로 나타난다는 뜻이다.', answer: '1', initials: '숫자', aliases: ['1','일'] }
      ]
    },
    quiz: {
      q1_text: '인물에서 산, 강, 도로, 건물 등 다양한 지형 요소를 약속된 표시로 나타낸 것에 대한 설명으로 가장 알맞은 것은 무엇인가요?',
      q1_opts: [
        '① 인물의 기호는 색깔 대신 그림을 이용해 지형을 예쁘게 꾸미는 것을 말한다.',
        '② 인물의 기호는 사람마다 다르게 사용할 수 있는 개인적인 약속을 의미한다.',
        '③ 인물의 기호는 산, 강, 도로, 건물 등을 일정한 약속에 따라 단순화하여 표시한 것이다.',
        '④ 인물의 기호는 실제 사진처럼 자세히 그려서 현실의 모습을 그대로 보여 주는 것이다.'
      ],
      q2_text: '다음 중 인물에서 높낮이의 차이를 표현하는 방법으로 가장 적절한 것은 무엇인가요?',
      q2_opts: [
        '① 인물에 글씨 크기를 다르게 써서 높은 지역을 표시한다.',
        '② 색깔과 등고선을 이용해 지형의 고도를 시각적으로 표현한다.',
        '③ 축척을 크게 하여 높은 곳과 낮은 곳의 거리를 계산한다.',
        '④ 방향표를 이용하여 높은 곳과 낮은 곳의 방향을 구분한다.'
      ],
      q3_html: `인물에는 실제 거리와 인물상의 거리를 일정한
    ...
    explain: {
      q1:'해설: 인물 기호는 지형 요소를 약속에 따라 단순화해 표시.',
      q2:'해설: 높낮이는 등고선과 색으로 표현.',
      q3:'해설: 실제/인물 거리의 관계=축척, 성격=비율.',
