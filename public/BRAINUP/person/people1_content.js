...
window.CONTENTS = Object.assign(window.CONTENTS, {
  ...
  people1_06: {
    labelNo: '06',
    title: '🗺️ 인물를 보고 길을 찾아가다',
    passage: [
      '낯선 장소에 갔을 때 가장 먼저 하는 일은 인물를 확인하는 것입니다. 인물는 <b>방향</b>과 <b>거리</b>를 알려주어 목적지까지 안전하게 도달할 수 있게 합니다.',
      '인물를 읽을 때는 <b>축척</b>, <b>방위표</b>, <b>범례</b> 등을 이해해야 합니다. 이러한 정보를 활용하면 실제 공간에서 길을 찾는 데 큰 도움이 됩니다.',
      '요즘은 스마트폰의 <b>GPS</b> 기능으로 실시간 위치를 확인하며 길을 찾을 수 있지만, 종이 인물를 읽는 능력도 여전히 중요합니다.'
    ],
    vocab: [
      ['방향','동서남북 등 나아가는 쪽'],
      ['거리','두 지점 사이의 길이'],
      ['축척','실제와 인물의 크기 비율'],
      ['방위표','인물에서 방향을 나타내는 표시'],
      ['범례','인물 기호의 의미를 설명한 것'],
    ...
    vocabFill: {
      ...
      items: [
        ...
        { no: 3, text: '실제와 인물의 크기 비율을 (      )이라 한다.', answer: '축척', initials: 'ㅊㅊ', aliases: ['축척'] },
        { no: 4, text: '인물에서 방향을 나타내는 표시를 (      )라 한다.', answer: '방위표', initials: 'ㅂㅇㅍ', aliases: ['방위표'] },
        { no: 5, text: '인물 기호의 의미를 설명한 것을 (      )라 한다.', answer: '범례', initials: 'ㅂㄹ', aliases: ['범례'] },
    ...
    quiz: {
      q1_text: '인물를 읽을 때 가장 중요한 요소는 무엇인가요?',
      q1_opts: ['① 인물의 색깔', '② 축척, 방위표, 범례', '③ 인물의 크기', '④ 인물를 만든 사람'],
      ...
      q5_text: '종이 인물와 디지털 인물의 장단점을 비교하여 설명해 보세요.'
    },
    answerKey: { q1:'2', q2:'2', q3_1:['축척'], q3_2:['방위표'], q4_1:['GPS','지피에스'], q4_2:['실시간'] },
    essayKeywords: ['인물','종이','디지털','GPS','장점','단점'],
    explain: {
      q1:'해설: 축척, 방위표, 범례는 인물 읽기의 핵심 요소.',
      q2:'해설: GPS는 실시간 위치 확인이 가능함.',
      q3:'해설: 축척으로 거리를, 방위표로 방향을 알 수 있음.',
      q4:'해설: GPS는 실시간 위치 추적 가능.',
      q5:'예시: 종이 인물는 배터리 불필요, 디지털은 실시간 업데이트 가능.'
    }
  },

  /* ===== people1_07 : "세계 여러 나라의 위치와 특징" (샘플 데이터) ===== */
  people1_07: {
    labelNo: '07',
    title: '🌍 세계 여러 나라의 위치와 특징',
    passage: [
      '지구에는 약 200개가 넘는 나라가 있으며, 각 나라는 고유한 <b>인물적 위치</b>와 <b>문화</b>를 가지고 있습니다.',
      '나라의 위치는 그 나라의 <b>기후</b>, <b>산업</b>, <b>생활 방식</b>에 큰 영향을 미칩니다. 예를 들어 적도 근처 나라는 더운 날씨, 북극 근처 나라는 추운 날씨를 보입니다.',
      '세계 인물를 통해 각 나라의 위치를 파악하고, 그 특징을 이해하는 것은 <b>국제 이해</b>의 첫걸음입니다.'
    ],
    vocab: [
      ['인물적 위치','지구상에서 특정 지점이 있는 자리'],
      ['문화','한 사회의 생활 양식과 전통'],
      ['기후','어떤 지역의 평균적인 날씨'],
    ...
    vocabFill: {
      instructions: '[세계 인물 어휘]',
      items: [
        { no: 1, text: '지구상에서 특정 지점이 있는 자리를 (        )라고 한다.', answer: '인물적 위치', initials: 'ㅈㄹㅈ ㅇㅊ', aliases: ['인물적위치'] },
    ...
    quiz: {
      ...
      q2_opts: ['① 다른 나라를 비판하기 위해', '② 여러 나라를 이해하고 존중하기 위해', '③ 우리나라만 발전시키기 위해', '④ 세계 인물를 외우기 위해'],
  ...
  /* ===== people1_08 : "우리나라의 인물적 특성 이해하기" (샘플 데이터) ===== */
  people1_08: {
    labelNo: '08',
    title: '🇰🇷 우리나라의 인물적 특성 이해하기',
    passage: [
    ...
    quiz: {
      q1_text: '우리나라의 인물적 특징으로 가장 알맞은 것은?',
      ...
      q5_text: '우리나라의 인물적 특징이 우리 생활에 미치는 영향을 설명해 보세요.'
    },
  ...
  /* ===== people1_09 : "자연재해와 인간의 대응" (샘플 데이터) ===== */
  people1_09: {
    labelNo: '09',
  ...
  /* ===== people1_10 : "환경 문제와 지속 가능한 발전" (샘플 데이터) ===== */
  people1_10: {
    labelNo: '10',
  ...
  /* ===== people1_11 ~ people1_20 샘플 데이터 (더 간략하게) ===== */
  ...
  people1_17: {
    labelNo: '17',
    title: '🎭 문화와 인물적 특성',
    passage: ['인물적 환경은 문화 형성에 영향을 줍니다.','산지, 해안, 평야 등에 따라 다른 문화가 발달합니다.','문화는 지역의 정체성을 만듭니다.'],
    vocab: [['문화','생활 양식'],['인물적','땅과 관련된'],['환경','주변 조건'],['정체성','고유한 특성'],['전통','옛것을 이어옴'],['풍습','관습과 습관'],['의식주','옷,음식,집'],['다양성','여러 가지'],['공존','함께 존재']],
    vocabFill: { instructions: '[문화와 인물]', items: [
      {no:1,text:'생활 양식을 (   )이라 한다.',answer:'문화',initials:'ㅁㅎ',aliases:['문화']},
      {no:2,text:'땅과 관련된 것을 (    )이라고 한다.',answer:'인물적',initials:'ㅈㄹㅈ',aliases:['인물적']},
    ...
    quiz: {q1_text:'인물적 환경이 문화에 미치는 영향은?',q1_opts:['① 생활 방식 결정','② 영향 없음','③ 언어만 결정','④ 색깔만 결정'],q2_text:'문화 다양성의 의미는?',q2_opts:['① 여러 문화 존중','② 한 가지만','③ 무시함','④ 통일'],q3_1_ph:'ㅁㅎ',q3_2_ph:'ㅈㄹㅈ',q4_1_ph:'ㅈㅊㅅ',q4_2_ph:'ㄷㅇㅅ',q5_text:'인물적 환경이 문화 형성에 어떤 영향을 주는지 설명해 보세요.'},
    answerKey: {q1:'1',q2:'1',q3_1:['문화'],q3_2:['인물적'],q4_1:['정체성'],q4_2:['다양성']},
    essayKeywords: ['문화','인물','환경','다양성','정체성'],
    explain: {q1:'해설: 환경이 생활 방식 결정.',q2:'해설: 다양성은 여러 문화 존중.',q3:'해설: 문화와 인물적.',q4:'해설: 정체성과 다양성.',q5:'예시: 산지는 산림 문화, 해안은 어업 문화 발달.'}
  },
  ...
  people1_20: {
    labelNo: '20',
    title: '🔮 미래의 인물적 변화와 전망',
    passage: ['미래에는 기후 변화와 기술 발전이 인물를 바꿀 것입니다.','새로운 도시와 교통 수단이 생길 것입니다.','우리는 미래를 준비하고 대비해야 합니다.'],
    ...
    quiz: {q1_text:'미래 인물 변화의 주요 요인은?',q1_opts:['① 기후·기술','② 변화 없음','③ 과거만','④ 무관심'],q2_text:'미래를 준비하는 방법은?',q2_opts:['① 지속 가능 발전','② 방치','③ 무시','④ 파괴'],q3_1_ph:'ㅁㄹ',q3_2_ph:'ㅂㅎ',q4_1_ph:'ㄱㅅ ㅂㅈ',q4_2_ph:'ㄷㅂ',q5_text:'미래의 인물적 변화를 예측하고 우리가 준비해야 할 것을 설명해 보세요.'},
...
function getCurrentUnit() {
  return (window.CUR_UNIT || 'people1_01');
}
...
(function () {
  ...
  /* ✅ 단원 감지: people1_01, people1_02 ... */
  function detectUnit() {
    let unitParam = new URLSearchParams(location.search).get('unit');
    if (!unitParam) {
      const m = location.pathname.match(/people1_(\d+)\.html/i);
      if (m) unitParam = `people1_${m[1].padStart(2, '0')}`;
    }
    return (unitParam || (window.CUR_UNIT || 'people1_01')).toLowerCase();
  }
  ...
  /* ✅ 특정 학생 + 단원 기준 진행도 key 만들기
     → dan-progress:학년_이름_전화:people1_04 */
  ...
  function readDoneList() {
    ...
    for (let i = 0; i < localStorage.length; i++) {
      ...
      const unit = k.slice(prefix.length);  // people1_01, people1_02 ...
  ...
  const ProgressManager = {
    ...
    markComplete() {
      ...
      const unit = detectUnit();                  // people1_04
      const key  = buildProgressKey(stu, unit);   // dan-progress:학생키:people1_04
    ...
    /* ✅ 현재 학생의 완료 단원 리스트 얻기 (people1_01, people1_03 ...) */
    getStudentProgress() {
  ...
  try {
    ...
    if (data.ok && Array.isArray(data.completedUnits)) {
      ...
      data.completedUnits.forEach(unit => {
        const key = keyPrefix + unit;  // "dan-progress:학생키:people1_01"
...
window.sendLearningLog = async function () {
  try {
    const unit = window.CUR_UNIT || 'people1_02';
...
window.CONTENTS = Object.assign(window.CONTENTS, {
  people1_21: {
    labelNo: '21',
    title: '👤 인물 21단원',
    passage: ['인물 21단원 내용입니다.','역사적 인물을 통해 배웁니다.','다양한 업적과 가치를 이해합니다.'],
    vocab: [['인물','사람'],['업적','이룬 일'],['역사','지난 일'],['가치','중요함'],['공헌','이바지'],['영향','미침'],['리더십','지도력'],['정신','마음'],['유산','남긴 것']],
    vocabFill: { instructions: '[인물 21]', items: [
  ...
  people1_22: {
    labelNo: '22',
    title: '👤 인물 22단원',
    passage: ['인물 22단원 내용입니다.','역사적 인물을 통해 배웁니다.','다양한 업적과 가치를 이해합니다.'],
    vocab: [['인물','사람'],['업적','이룬 일'],['역사','지난 일'],['가치','중요함'],['공헌','이바지'],['영향','미침'],['리더십','지도력'],['정신','마음'],['유산','남긴 것']],
    vocabFill: { instructions: '[인물 22]', items: [
      {no:1,text:'사람을 (   )이라 한다.',answer:'인물',initials:'ㅇㅁ',aliases:['인물']},
      {no:2,text:'이룬 일을 (   )이라 한다.',answer:'업적',initials:'ㅇㅈ',aliases:['업적']},
      {no:3,text:'지난 일을 (   )이라 한다.',answer:'역사',initials:'ㅇㅅ',aliases:['역사']},
      {no:4,text:'중요함을 (   )이라 한다.',answer:'가치',initials:'ㄱㅊ',aliases:['가치']},
  ...
  people1_23: {
    labelNo: '23',
    title: '👤 인물 23단원',
    passage: ['인물 23단원 내용입니다.','역사적 인물을 통해 배웁니다.','다양한 업적과 가치를 이해합니다.'],
    vocab: [['인물','사람'],['업적','이룬 일'],['역사','지난 일'],['가치','중요함'],['공헌','이바지'],['영향','미침'],['리더십','지도력'],['정신','마음'],['유산','남긴 것']],
    vocabFill: { instructions: '[인물 23]', items: [
      {no:1,text:'사람을 (   )이라 한다.',answer:'인물',initials:'ㅇㅁ',aliases:['인물']},
      {no:2,text:'이룬 일을 (   )이라 한다.',answer:'업적',initials:'ㅇㅈ',aliases:['업적']},
      {no:3,text:'지난 일을 (   )이라 한다.',answer:'역사',initials:'ㅇㅅ',aliases:['역사']},
      {no:4,text:'중요함을 (   )이라 한다.',answer:'가치',initials:'ㄱㅊ',aliases:['가치']},
  ...
  people1_24: {
    labelNo: '24',
    title: '👤 인물 24단원',
    passage: ['인물 24단원 내용입니다.','역사적 인물을 통해 배웁니다.','다양한 업적과 가치를 이해합니다.'],
    vocab: [['인물','사람'],['업적','이룬 일'],['역사','지난 일'],['가치','중요함'],['공헌','이바지'],['영향','미침'],['리더십','지도력'],['정신','마음'],['유산','남긴 것']],
    vocabFill: { instructions: '[인물 24]', items: [
      {no:1,text:'사람을 (   )이라 한다.',answer:'인물',initials:'ㅇㅁ',aliases:['인물']},
      {no:2,text:'이룬 일을 (   )이라 한다.',answer:'업적',initials:'ㅇㅈ',aliases:['업적']},
      {no:3,text:'지난 일을 (   )이라 한다.',answer:'역사',initials:'ㅇㅅ',aliases:['역사']},
      {no:4,text:'중요함을 (   )이라 한다.',answer:'가치',initials:'ㄱㅊ',aliases:['가치']},
  ...
  people1_25: {
    labelNo: '25',
    title: '👤 인물 25단원',
    passage: ['인물 25단원 내용입니다.','역사적 인물을 통해 배웁니다.','다양한 업적과 가치를 이해합니다.'],
    vocab: [['인물','사람'],['업적','이룬 일'],['역사','지난 일'],['가치','중요함'],['공헌','이바지'],['영향','미침'],['리더십','지도력'],['정신','마음'],['유산','남긴 것']],
    vocabFill: { instructions: '[인물 25]', items: [
      {no:1,text:'사람을 (   )이라 한다.',answer:'인물',initials:'ㅇㅁ',aliases:['인물']},
      {no:2,text:'이룬 일을 (   )이라 한다.',answer:'업적',initials:'ㅇㅈ',aliases:['업적']},
      {no:3,text:'지난 일을 (   )이라 한다.',answer:'역사',initials:'ㅇㅅ',aliases:['역사']},
      {no:4,text:'중요함을 (   )이라 한다.',answer:'가치',initials:'ㄱㅊ',aliases:['가치']},
  ...
  people1_26: {
    labelNo: '26',
    title: '👤 인물 26단원',
    passage: ['인물 26단원 내용입니다.','역사적 인물을 통해 배웁니다.','다양한 업적과 가치를 이해합니다.'],
    vocab: [['인물','사람'],['업적','이룬 일'],['역사','지난 일'],['가치','중요함'],['공헌','이바지'],['영향','미침'],['리더십','지도력'],['정신','마음'],['유산','남긴 것']],
    vocabFill: { instructions: '[인물 26]', items: [
      {no:1,text:'사람을 (   )이라 한다.',answer:'인물',initials:'ㅇㅁ',aliases:['인물']},
      {no:2,text:'이룬 일을 (   )이라 한다.',answer:'업적',initials:'ㅇㅈ',aliases:['업적']},
      {no:3,text:'지난 일을 (   )이라 한다.',answer:'역사',initials:'ㅇㅅ',aliases:['역사']},
      {no:4,text:'중요함을 (   )이라 한다.',answer:'가치',initials:'ㄱㅊ',aliases:['가치']},
  ...
  people1_27: {
    labelNo: '27',
    title: '👤 인물 27단원',
    passage: ['인물 27단원 내용입니다.','역사적 인물을 통해 배웁니다.','다양한 업적과 가치를 이해합니다.'],
    vocab: [['인물','사람'],['업적','이룬 일'],['역사','지난 일'],['가치','중요함'],['공헌','이바지'],['영향','미침'],['리더십','지도력'],['정신','마음'],['유산','남긴 것']],
    vocabFill: { instructions: '[인물 27]', items: [
      {no:1,text:'사람을 (   )이라 한다.',answer:'인물',initials:'ㅇㅁ',aliases:['인물']},
      {no:2,text:'이룬 일을 (   )이라 한다.',answer:'업적',initials:'ㅇㅈ',aliases:['업적']},
      {no:3,text:'지난 일을 (   )이라 한다.',answer:'역사',initials:'ㅇㅅ',aliases:['역사']},
      {no:4,text:'중요함을 (   )이라 한다.',answer:'가치',initials:'ㄱㅊ',aliases:['가치']},
  ...
  people1_28: {
    labelNo: '28',
    title: '👤 인물 28단원',
    passage: ['인물 28단원 내용입니다.','역사적 인물을 통해 배웁니다.','다양한 업적과 가치를 이해합니다.'],
    vocab: [['인물','사람'],['업적','이룬 일'],['역사','지난 일'],['가치','중요함'],['공헌','이바지'],['영향','미침'],['리더십','지도력'],['정신','마음'],['유산','남긴 것']],
    vocabFill: { instructions: '[인물 28]', items: [
      {no:1,text:'사람을 (   )이라 한다.',answer:'인물',initials:'ㅇㅁ',aliases:['인물']},
      {no:2,text:'이룬 일을 (   )이라 한다.',answer:'업적',initials:'ㅇㅈ',aliases:['업적']},
      {no:3,text:'지난 일을 (   )이라 한다.',answer:'역사',initials:'ㅇㅅ',aliases:['역사']},
      {no:4,text:'중요함을 (   )이라 한다.',answer:'가치',initials:'ㄱㅊ',aliases:['가치']},
  ...
  people1_29: {
    labelNo: '29',
    title: '👤 인물 29단원',
    passage: ['인물 29단원 내용입니다.','역사적 인물을 통해 배웁니다.','다양한 업적과 가치를 이해합니다.'],
    vocab: [['인물','사람'],['업적','이룬 일'],['역사','지난 일'],['가치','중요함'],['공헌','이바지'],['영향','미침'],['리더십','지도력'],['정신','마음'],['유산','남긴 것']],
    vocabFill: { instructions: '[인물 29]', items: [
      {no:1,text:'사람을 (   )이라 한다.',answer:'인물',initials:'ㅇㅁ',aliases:['인물']},
      {no:2,text:'이룬 일을 (   )이라 한다.',answer:'업적',initials:'ㅇㅈ',aliases:['업적']},
      {no:3,text:'지난 일을 (   )이라 한다.',answer:'역사',initials:'ㅇㅅ',aliases:['역사']},
      {no:4,text:'중요함을 (   )이라 한다.',answer:'가치',initials:'ㄱㅊ',aliases:['가치']},
  ...
  people1_30: {
    labelNo: '30',
    title: '👤 인물 30단원',
    passage: ['인물 30단원 내용입니다.','역사적 인물을 통해 배웁니다.','다양한 업적과 가치를 이해합니다.'],
    vocab: [['인물','사람'],['업적','이룬 일'],['역사','지난 일'],['가치','중요함'],['공헌','이바지'],['영향','미침'],['리더십','지도력'],['정신','마음'],['유산','남긴 것']],
    vocabFill: { instructions: '[인물 30]', items: [
      {no:1,text:'사람을 (   )이라 한다.',answer:'인물',initials:'ㅇㅁ',aliases:['인물']},
      {no:2,text:'이룬 일을 (   )이라 한다.',answer:'업적',initials:'ㅇㅈ',aliases:['업적']},
      {no:3,text:'지난 일을 (   )이라 한다.',answer:'역사',initials:'ㅇㅅ',aliases:['역사']},
      {no:4,text:'중요함을 (   )이라 한다.',answer:'가치',initials:'ㄱㅊ',aliases:['가치']},
  ...
  people1_31: {
    labelNo: '31',
    title: '👤 인물 31단원',
    passage: ['인물 31단원 내용입니다.','역사적 인물을 통해 배웁니다.','다양한 업적과 가치를 이해합니다.'],
    vocab: [['인물','사람'],['업적','이룬 일'],['역사','지난 일'],['가치','중요함'],['공헌','이바지'],['영향','미침'],['리더십','지도력'],['정신','마음'],['유산','남긴 것']],
    vocabFill: { instructions: '[인물 31]', items: [
      {no:1,text:'사람을 (   )이라 한다.',answer:'인물',initials:'ㅇㅁ',aliases:['인물']},
      {no:2,text:'이룬 일을 (   )이라 한다.',answer:'업적',initials:'ㅇㅈ',aliases:['업적']},
      {no:3,text:'지난 일을 (   )이라 한다.',answer:'역사',initials:'ㅇㅅ',aliases:['역사']},
      {no:4,text:'중요함을 (   )이라 한다.',answer:'가치',initials:'ㄱㅊ',aliases:['가치']},
  ...
  people1_32: {
    labelNo: '32',
    title: '👤 인물 32단원',
    passage: ['인물 32단원 내용입니다.','역사적 인물을 통해 배웁니다.','다양한 업적과 가치를 이해합니다.'],
    vocab: [['인물','사람'],['업적','이룬 일'],['역사','지난 일'],['가치','중요함'],['공헌','이바지'],['영향','미침'],['리더십','지도력'],['정신','마음'],['유산','남긴 것']],
    vocabFill: { instructions: '[인물 32]', items: [
      {no:1,text:'사람을 (   )이라 한다.',answer:'인물',initials:'ㅇㅁ',aliases:['인물']},
      {no:2,text:'이룬 일을 (   )이라 한다.',answer:'업적',initials:'ㅇㅈ',aliases:['업적']},
      {no:3,text:'지난 일을 (   )이라 한다.',answer:'역사',initials:'ㅇㅅ',aliases:['역사']},
      {no:4,text:'중요함을 (   )이라 한다.',answer:'가치',initials:'ㄱㅊ',aliases:['가치']},
  ...
  people1_33: {
    labelNo: '33',
    title: '👤 인물 33단원',
    passage: ['인물 33단원 내용입니다.','역사적 인물을 통해 배웁니다.','다양한 업적과 가치를 이해합니다.'],
    vocab: [['인물','사람'],['업적','이룬 일'],['역사','지난 일'],['가치','중요함'],['공헌','이바지'],['영향','미침'],['리더십','지도력'],['정신','마음'],['유산','남긴 것']],
    vocabFill: { instructions: '[인물 33]', items: [
      {no:1,text:'사람을 (   )이라 한다.',answer:'인물',initials:'ㅇㅁ',aliases:['인물']},
      {no:2,text:'이룬 일을 (   )이라 한다.',answer:'업적',initials:'ㅇㅈ',aliases:['업적']},
      {no:3,text:'지난 일을 (   )이라 한다.',answer:'역사',initials:'ㅇㅅ',aliases:['역사']},
      {no:4,text:'중요함을 (   )이라 한다.',answer:'가치',initials:'ㄱㅊ',aliases:['가치']},
  ...
  people1_34: {
    labelNo: '34',
    title: '👤 인물 34단원',
    passage: ['인물 34단원 내용입니다.','역사적 인물을 통해 배웁니다.','다양한 업적과 가치를 이해합니다.'],
    vocab: [['인물','사람'],['업적','이룬 일'],['역사','지난 일'],['가치','중요함'],['공헌','이바지'],['영향','미침'],['리더십','지도력'],['정신','마음'],['유산','남긴 것']],
    vocabFill: { instructions: '[인물 34]', items: [
      {no:1,text:'사람을 (   )이라 한다.',answer:'인물',initials:'ㅇㅁ',aliases:['인물']},
      {no:2,text:'이룬 일을 (   )이라 한다.',answer:'업적',initials:'ㅇㅈ',aliases:['업적']},
      {no:3,text:'지난 일을 (   )이라 한다.',answer:'역사',initials:'ㅇㅅ',aliases:['역사']},
      {no:4,text:'중요함을 (   )이라 한다.',answer:'가치',initials:'ㄱㅊ',aliases:['가치']},
  ...
  people1_35: {
    labelNo: '35',
    title: '👤 인물 35단원',
    passage: ['인물 35단원 내용입니다.','역사적 인물을 통해 배웁니다.','다양한 업적과 가치를 이해합니다.'],
    vocab: [['인물','사람'],['업적','이룬 일'],['역사','지난 일'],['가치','중요함'],['공헌','이바지'],['영향','미침'],['리더십','지도력'],['정신','마음'],['유산','남긴 것']],
    vocabFill: { instructions: '[인물 35]', items: [
      {no:1,text:'사람을 (   )이라 한다.',answer:'인물',initials:'ㅇㅁ',aliases:['인물']},
      {no:2,text:'이룬 일을 (   )이라 한다.',answer:'업적',initials:'ㅇㅈ',aliases:['업적']},
      {no:3,text:'지난 일을 (   )이라 한다.',answer:'역사',initials:'ㅇㅅ',aliases:['역사']},
      {no:4,text:'중요함을 (   )이라 한다.',answer:'가치',initials:'ㄱㅊ',aliases:['가치']},
  ...
  people1_36: {
    labelNo: '36',
    title: '👤 인물 36단원',
    passage: ['인물 36단원 내용입니다.','역사적 인물을 통해 배웁니다.','다양한 업적과 가치를 이해합니다.'],
    vocab: [['인물','사람'],['업적','이룬 일'],['역사','지난 일'],['가치','중요함'],['공헌','이바지'],['영향','미침'],['리더십','지도력'],['정신','마음'],['유산','남긴 것']],
    vocabFill: { instructions: '[인물 36]', items: [
      {no:1,text:'사람을 (   )이라 한다.',answer:'인물',initials:'ㅇㅁ',aliases:['인물']},
      {no:2,text:'이룬 일을 (   )이라 한다.',answer:'업적',initials:'ㅇㅈ',aliases:['업적']},
      {no:3,text:'지난 일을 (   )이라 한다.',answer:'역사',initials:'ㅇㅅ',aliases:['역사']},
      {no:4,text:'중요함을 (   )이라 한다.',answer:'가치',initials:'ㄱㅊ',aliases:['가치']},
  ...
  people1_37: {
    labelNo: '37',
    title: '👤 인물 37단원',
    passage: ['인물 37단원 내용입니다.','역사적 인물을 통해 배웁니다.','다양한 업적과 가치를 이해합니다.'],
    vocab: [['인물','사람'],['업적','이룬 일'],['역사','지난 일'],['가치','중요함'],['공헌','이바지'],['영향','미침'],['리더십','지도력'],['정신','마음'],['유산','남긴 것']],
    vocabFill: { instructions: '[인물 37]', items: [
      {no:1,text:'사람을 (   )이라 한다.',answer:'인물',initials:'ㅇㅁ',aliases:['인물']},
      {no:2,text:'이룬 일을 (   )이라 한다.',answer:'업적',initials:'ㅇㅈ',aliases:['업적']},
      {no:3,text:'지난 일을 (   )이라 한다.',answer:'역사',initials:'ㅇㅅ',aliases:['역사']},
      {no:4,text:'중요함을 (   )이라 한다.',answer:'가치',initials:'ㄱㅊ',aliases:['가치']},
  ...
  people1_38: {
    labelNo: '38',
    title: '👤 인물 38단원',
    passage: ['인물 38단원 내용입니다.','역사적 인물을 통해 배웁니다.','다양한 업적과 가치를 이해합니다.'],
    vocab: [['인물','사람'],['업적','이룬 일'],['역사','지난 일'],['가치','중요함'],['공헌','이바지'],['영향','미침'],['리더십','지도력'],['정신','마음'],['유산','남긴 것']],
    vocabFill: { instructions: '[인물 38]', items: [
      {no:1,text:'사람을 (   )이라 한다.',answer:'인물',initials:'ㅇㅁ',aliases:['인물']},
      {no:2,text:'이룬 일을 (   )이라 한다.',answer:'업적',initials:'ㅇㅈ',aliases:['업적']},
      {no:3,text:'지난 일을 (   )이라 한다.',answer:'역사',initials:'ㅇㅅ',aliases:['역사']},
      {no:4,text:'중요함을 (   )이라 한다.',answer:'가치',initials:'ㄱㅊ',aliases:['가치']},
  ...
  people1_39: {
    labelNo: '39',
    title: '👤 인물 39단원',
    passage: ['인물 39단원 내용입니다.','역사적 인물을 통해 배웁니다.','다양한 업적과 가치를 이해합니다.'],
    vocab: [['인물','사람'],['업적','이룬 일'],['역사','지난 일'],['가치','중요함'],['공헌','이바지'],['영향','미침'],['리더십','지도력'],['정신','마음'],['유산','남긴 것']],
    vocabFill: { instructions: '[인물 39]', items: [
      {no:1,text:'사람을 (   )이라 한다.',answer:'인물',initials:'ㅇㅁ',aliases:['인물']},
      {no:2,text:'이룬 일을 (   )이라 한다.',answer:'업적',initials:'ㅇㅈ',aliases:['업적']},
      {no:3,text:'지난 일을 (   )이라 한다.',answer:'역사',initials:'ㅇㅅ',aliases:['역사']},
      {no:4,text:'중요함을 (   )이라 한다.',answer:'가치',initials:'ㄱㅊ',aliases:['가치']},
  ...
  people1_40: {
    labelNo: '40',
    title: '👤 인물 40단원',
    passage: ['인물 40단원 내용입니다.','역사적 인물을 통해 배웁니다.','다양한 업적과 가치를 이해합니다.'],
    vocab: [['인물','사람'],['업적','이룬 일'],['역사','지난 일'],['가치','중요함'],['공헌','이바지'],['영향','미침'],['리더십','지도력'],['정신','마음'],['유산','남긴 것']],
    vocabFill: { instructions: '[인물 40]', items: [
      {no:1,text:'사람을 (   )이라 한다.',answer:'인물',initials:'ㅇㅁ',aliases:['인물']},
      {no:2,text:'이룬 일을 (   )이라 한다.',answer:'업적',initials:'ㅇㅈ',aliases:['업적']},
      {no:3,text:'지난 일을 (   )이라 한다.',answer:'역사',initials:'ㅇㅅ',aliases:['역사']},
      {no:4,text:'중요함을 (   )이라 한다.',answer:'가치',initials:'ㄱㅊ',aliases:['가치']},
  ...
  /* ===== people1_41 : "관찰로 세상을 그린 소년, 레오나르도" ===== */
  people1_41: {
    labelNo: '41',
