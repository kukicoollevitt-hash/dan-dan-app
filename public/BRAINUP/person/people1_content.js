...
window.CONTENTS = Object.assign(window.CONTENTS, {
  ...
  /* ===== people1_04 : “인물의 좌표와 경위도” ===== */
  people1_04: {
    labelNo: '04',
    title: '🧭 인물의 좌표와 경위도',
    passage: [
      '인물의 위치를 정확하게 나타내기 위해 좌표 체계를 사용한다. 가장 널리 쓰이는 방식이 지구를 둘러싼 가상의 선인 <b>경선</b>과 <b>위선</b>이다.',
      ...
      '종이 인물에서는 격자(grid)나 눈금을 사용해 좌표를 읽고, 디지털 인물에서는 터치로 좌표를 복사하거나 검색창에 위도·경도를 입력해 위치를 찾을 수 있다.'
    ],
    vocab: [
    ...
    vocabFill: {
      ...
      items: [
        ...
        { no: 5, text: '인물를 일정 간격으로 나눈 선들의 모음을 (      )라고 한다.', answer: '격자', initials: 'ㄱㅈ', aliases: ['격자','grid'] },
