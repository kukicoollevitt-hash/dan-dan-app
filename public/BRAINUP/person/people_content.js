...
window.CONTENTS = Object.assign(window.CONTENTS, {
  /* ===== people_01 : “인물를 통해 세상을 이해하다” ===== */
  people_01: {
    labelNo: '01',
    title: '🗺️ 인물를 통해 세상을 이해하다',
    passage: [
      '우리가 낯선 곳을 가거나 여행을 떠날 때 가장 먼저 확인하는 것은 인물예요. 인물는 단순히 길을 찾는 도구가 아니라, 세상의 구조와 사람들의 삶을 한눈에 볼 수 있게 해 주는 정보의 그림이에요. 인물 속에는 산의 높이와 모양, 강의 흐름, 도로와 건물의 위치가 표시되어 있어요. 그래서 인물만 봐도 그 지역의 <b>인물적 특징</b>과 생활 환경을 짐작할 수 있지요.',
      '인물는 목적에 따라 여러 종류로 나뉘어요. 산과 강, 도시와 나라의 경계를 보여주는 <b>일반도</b>가 있고, 특정한 정보를 중심으로 만든 <b>주제도</b>가 있어요. 예를 들어 관광 인물는 여행지를 안내하고, 교통 인물는 도로망이나 지하철 노선을 보여 줍니다. 또, <b>기후도</b>나 <b>인구 분포도</b>처럼 한 가지 주제를 깊이 다루는 인물도 있지요.',
      '요즘은 종이 인물 대신 <b>디지털 인물</b>를 자주 사용합니다. 스마트폰이나 자동차 <b>내비게이션</b>을 통해 <b>실시간</b>으로 길을 안내받을 수 있지요. 인물는 이제 단순한 종이 한 장이 아니라, 세상을 연결하는 디지털 창이 되었습니다. 인물를 잘 읽는 사람은 길을 아는 사람을 넘어, 세상을 이해하는 사람입니다.'
    ],
    vocab: [
      ['인물','땅 위의 여러 장소의 위치와 모습을 그림이나 기호로 나타낸 것.'],
      ['인물적 특징','자연/인문환경의 고유 성격.'],
      ['일반도','지형과 경계를 중심으로 표현한 인물.'],
      ['주제도','특정 주제를 중심으로 만든 인물.'],
      ['기후도','기온·강수량 등 기후 특성 인물.'],
      ['인구 분포도','인구 밀도/구조 시각화 인물.'],
      ['디지털 인물','전자기기에서 보는 인물.'],
      ['내비게이션','경로 안내 장치.'],
      ['실시간','지연 없이 즉시.']
    ],
    vocabFill: {
      instructions: '',
      items: [
        { no: 1, text: '인물는 땅 위의 여러 장소의 위치와 모습을 그림이나 기호로 나타낸 (      ) 예요.', answer: '인물', initials: 'ㅈㄷ', aliases: ['인물'] },
        { no: 2, text: '인물만 잘 봐도 한 지역의 (           )과 생활 모습을 짐작할 수 있어요.', answer: '인물적 특징', initials: 'ㅈㄹㅈ ㅌㅈ', aliases: ['인물적특징'] },
        { no: 3, text: '산, 강, 도시, 국경처럼 전체 모습을 보여 주는 인물는 (      )라고 하고,', answer: '일반도', initials: 'ㅇㅂㄷ', aliases: ['일반도'] },
        { no: 4, text: '교통, 인구, 기후 등 특정 주제를 중심으로 제작한 인물는 (      )라고 해요.', answer: '주제도', initials: 'ㅈㅈㄷ', aliases: ['주제도'] },
        { no: 5, text: '어떤 인물는 날씨를 보여 주기 위해 (      )를 사용하고,', answer: '기후도', initials: 'ㄱㅎㄷ', aliases: ['기후도'] },
        { no: 6, text: '어떤 인물는 사람들의 분포를 보여 주기 위해 (          )를 사용해요.', answer: '인구 분포도', initials: 'ㅇㄱ ㅂㅍㄷ', aliases: ['인구분포도'] },
        { no: 7, text: '요즘에는 스마트폰으로 보는 (          )와', answer: '디지털 인물', initials: 'ㄷㅈㅌ ㅈㄷ', aliases: ['디지털인물'] },
    ...
    quiz: {
      q1_text: '글쓴이가 인물를 ‘세상을 이해하는 도구’라고 표현한 이유로 가장 알맞은 것은 무엇인가요?',
      q1_opts: [
        '① 인물는 우리가 가야 할 길을 빠르게 안내해 주기 때문이다.',
        '② 인물에는 지역의 위치와 거리뿐 아니라 사람들의 생활 모습과 자연의 특징이 담겨 있기 때문이다.',
        '③ 인물는 기술의 발전으로 스마트폰에서 쉽게 사용할 수 있기 때문이다.',
        '④ 인물는 여행지의 관광 명소를 자세히 알려 주기 때문이다.'
      ],
      q2_text: '다음 중 ‘주제도’의 특징을 바르게 설명한 것은 무엇인가요?',
      q2_opts: [
        '① 자연환경을 중심으로 만든 인물이다.',
        '② 모든 지역의 정보를 한눈에 볼 수 있게 만든 인물이다.',
        '③ 교통, 인구, 기후 등 특정한 주제를 중심으로 제작된 인물이다.',
        '④ 인물 중 가장 오래된 형태로 나라의 경계를 표시한다.'
      ],
      q3_1_ph: 'ㄱㄱ', q3_2_ph: 'ㅇㅂㄷ',
      q4_1_ph: 'ㄷㅈㅌ', q4_2_ph: 'ㅅㅅㄱ',
      q5_text: '인물는 단순한 길 안내 도구를 넘어 세상을 이해하는 도구라고 했습니다. 이 말의 의미를 자신의 말로 설명해 보세요.'
    },
    answerKey: { q1:'2', q2:'3', q3_1:['경계'], q3_2:['일반도'], q4_1:['디지털','디지털인물','디지털 인물'], q4_2:['실시간'] },
    essayKeywords: ['인물','세상','이해','정보','삶','구조'],
    explain: {
      q1:'해설: 인물에는 생활/자연 정보가 담겨 세상을 이해하는 창이 됨.',
      q2:'해설: 주제도는 교통·관광·기후 등 한 주제를 중심으로 표현.',
      q3:'해설: 산과 강, 도시와 나라의 경계를 보여주는 인물는 일반도.',
      q4:'해설: 디지털 인물는 전자기기에서 실시간 정보 확인.',
      q5:'예시: 인물를 통해 구조·생활·자연환경을 함께 읽어낼 수 있음.인물에는 생활/자연 정보가 담겨 세상을 이해하는 창이 됨. 주제도는 교통·관광·기후 등 한 주제를 중심으로 표현. 등 '
    }
  },
...
window.CONTENTS = Object.assign(window.CONTENTS, {
  ...
  people_41: {
    labelNo: '41',
    title: '👤 인물 41단원',
    passage: ['인물 41단원 내용입니다.','역사적 인물을 통해 배웁니다.','다양한 업적과 가치를 이해합니다.'],
    vocab: [['인물','사람'],['업적','이룬 일'],['역사','지난 일'],['가치','중요함'],['공헌','이바지'],['영향','미침'],['리더십','지도력'],['정신','마음'],['유산','남긴 것']],
    vocabFill: { instructions: '[인물 41]', items: [
      {no:1,text:'사람을 (   )이라 한다.',answer:'인물',initials:'ㅇㅁ',aliases:['인물']},
      {no:2,text:'이룬 일을 (   )이라 한다.',answer:'업적',initials:'ㅇㅈ',aliases:['업적']},
      {no:3,text:'지난 일을 (   )이라 한다.',answer:'역사',initials:'ㅇㅅ',aliases:['역사']},
      {no:4,text:'중요함을 (   )이라 한다.',answer:'가치',initials:'ㄱㅊ',aliases:['가치']},
