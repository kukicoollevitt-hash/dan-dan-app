...
window.CONTENTS = Object.assign(window.CONTENTS, {
  ...
  chem_01: {
    ...
    passage: [
      ...
      '예를 들어 플라스틱은 단단하지만 가볍고 <b>매끄럽다</b>서 여러 물건에 쓰이고, 고무는 잘 늘어나고 <b>질기다</b>서 충격을 받아도 쉽게 부서지지 않아요. <b>철</b>은 무겁고 단단해 건물이나 도구를 만드는 데 활용되지요. 이런 물질의 <b>성질</b>을 잘 활용하면 우리 생활에 더 편리한 물체를 만들 수 있어요.'
    ],
    vocab: [
      ...
      ['매끄럽다','표면이 거칠지 않고 부드러운 상태.'],
      ['질기다','잘 끊어지거나 찢어지지 않고 튼튼한 상태.']
    ],
    vocabFill: {
      instructions: '',
      items: [
        ...
        { no: 7, text: '플라스틱은 표면이 (        )서 여러 물건에 쓰여요.', answer: '매끄럽다', initials: 'ㅁㄲㄹㄷ', aliases: ['매끄럽다','매끄러워'] },
        { no: 8, text: '고무는 (      )서 충격을 받아도 쉽게 부서지지 않아요.', answer: '질기다', initials: 'ㅈㄱㄷ', aliases: ['질기다','질겨'] }
      ]
    },
    quiz: {
