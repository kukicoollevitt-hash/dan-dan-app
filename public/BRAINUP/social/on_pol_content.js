...
window.CONTENTS = Object.assign(window.CONTENTS, {
  ...
  on_pol_01: {
    ...
    essayKeywords: ['정치','갈등','이해관계','조정','권한','참여','학급회의','주민 회의'],
    explain: {
      q1: '정치란 사람들 사이에 생긴 의견 차이와 이해관계를 조정하고 모두가 더 나은 방향으로 살아갈 수 있도록 돕는 활동을 뜻해요.',
      q2: '정치를 좁은 의미로 보면, 나라를 이끌기 위해 권한을 가진 사람들이 하는 활동을 말해요. (...) 하지만 넓은 의미로 보면, 정치란 사람들 사이에 생긴 의견 차이와 이해관계를 조정하고 모두가 더 나은 방향으로 살아갈 수 있도록 돕는 활동을 뜻해요.',
      ...
      q5: '예시 답안: 정치란 사람들 사이의 의견 차이와 이해관계를 조정하여 더 나은 방향으로 이끄는 활동입니다. 학급회의, 가족회의, 주민 회의도 넓은 의미의 정치 활동에 해당합니다.'
    },
    detail: {
      q1: '정답: ②번. 2문단에서 "정치란 사람들 사이에 생긴 의견 차이와 이해관계를 조정하고 모두가 더 나은 방향으로 살아갈 수 있도록 돕는 활동"이라고 설명합니다. ①정치는 국민도 참여 가능, ③법만이 아님, ④상시적 활동.',
  ...
  on_pol_02: {
    ...
    detail: {
      q1: '정답: ②번. 1문단에서 "민주주의 사회에서는 나라의 실제 주인이 국민"이라고 설명합니다. ①왕/귀족 아님, ③국민 참여 가능, ④돈과 무관.',
  ...
  on_pol_03: {
    ...
    essayKeywords: ['4·19 혁명','5·18 민주화 운동','6월 민주항쟁','직선제','지방자치제','시민 단체','민주주의','시민 참여'],
    explain: {
      ...
      q3: '1987년에는 전국적으로 시민들이 참여한 6월 민주항쟁이 일어났습니다. 이 운동을 통해 대통령을 국민이 직접 뽑는 직선제가 도입되고, 표현·언론의 자유도 크게 확장되었어요.',
      q4: '우리나라의 민주주의는 시민들이 직접 행동하고 참여해 만들어 낸 결과입니다.',
      q5: '예시 답안: 우리나라의 민주주의는 4·19 혁명, 5·18 민주화 운동, 6월 민주항쟁 등 시민들의 용기와 희생으로 발전해 왔습니다. 6월 민주항쟁을 통해 직선제가 도입되었습니다.'
    },
    detail: {
      q1: '정답: ②번. 1문단에서 "당시 정권이 부정한 방식으로 선거를 치르자 학생과 시민들이 이에 강하게 반발"했다고 설명합니다. ①경제 위기 아님, ③외국 침략 아님, ④지방자치제와 무관.',
  ...
  on_pol_04: {
    ...
    essayKeywords: ['다수결','소수 의견','토론','타협','관용','민주주의','존중','양보'],
    explain: {
      q1: '민주주의 사회에서는 여러 사람의 의견을 정리하고 결정을 내릴 때 다수결의 원칙을 자주 사용해요. 더 많은 사람이 지지하는 의견을 공동의 의사로 삼는 방식이지요.',
      q2: '민주적인 결정을 위해서는 먼저 서로의 이야기를 듣고 토론하는 과정이 필요합니다. (...) 무엇보다 소수 의견을 존중하는 관용의 자세가 민주주의의 핵심입니다.',
    ...
    detail: {
      q1: '정답: ③번. 1문단에서 "여러 사람의 의견을 정리하고 결정을 내릴 때 다수결의 원칙을 자주 사용"한다고 설명합니다. ①②완벽하지 않음, ④갈등 완전 해소 불가.',
  ...
  on_pol_05: {
    ...
    essayKeywords: ['주권','대표 민주주의','보통 선거','직접 선거','평등 선거','비밀 선거','유권자','투표'],
    explain: {
      q1: '현대 사회는 규모도 크고 처리해야 할 일도 많아서 모든 국민이 직접 정치에 참여하기는 어려워요. 그래서 대부분의 민주 국가는 국민이 자신의 뜻을 대신할 사람을 선거로 뽑는 대표 민주주의 방식을 사용해요.',
      q2: '평등 선거는 모든 사람이 똑같이 한 표씩 행사하는 것을 뜻해요. (...) 또한 비밀 선거는 누가 어떤 후보를 선택했는지 다른 사람이 알 수 없도록 보장하는 원칙이에요.',
      q3: '공약 - 후보자가 당선되면 실천하겠다고 약속하는 내용',
      q4: '비밀 선거는 누가 어떤 후보를 선택했는지 다른 사람이 알 수 없도록 보장하는 원칙이에요. 이 원칙 덕분에 눈치를 보지 않고 자유롭게 투표할 수 있어요.',
      q5: '예시 답안: 민주 선거의 네 가지 원칙은 보통 선거, 직접 선거, 평등 선거, 비밀 선거입니다. 비밀 선거 덕분에 압력 없이 자유롭게 투표할 수 있습니다.'
    },
    detail: {
      q1: '정답: ③번. 1문단에서 "현대 사회는 규모도 크고 처리해야 할 일도 많아서 모든 국민이 직접 정치에 참여하기는 어렵다"고 설명합니다. ①관심 없어서 아님, ②법 금지 아님, ④대표자 권리 더 많지 않음.',
  ...
  on_pol_06: {
    ...
    essayKeywords: ['삼권분립','입법권','행정권','사법권','국회','정부','법원','견제','균형'],
    explain: {
      q1: '국가 권력을 여러 기관으로 나누어 서로 견제하고 균형을 이루게 만들었어요. 이것을 삼권분립이라 하며, 프랑스의 사상가 몽테스키외가 처음 주장한 원리예요.',
      q2: '입법권은 법을 만드는 권한으로 국회가 담당합니다. (...) 행정권은 법에 따라 나라의 일을 집행하는 권한으로 정부가 담당합니다.',
      q3: '사법권은 법에 따라 재판을 하는 권한으로 법원이 담당해요.',
    ...
    detail: {
      q1: '정답: ①번. 1문단에서 "국가 권력을 여러 기관으로 나누어 서로 견제하고 균형을 이루게 만들었어요. 이것을 삼권분립이라 한다"고 설명합니다. ②한 기관 집중 아님, ③직접 민주주의 아님, ④대통령 지휘 아님.',
  ...
  on_pol_07: {
    ...
    essayKeywords: ['지방자치','풀뿌리 민주주의','지방의회','지방자치단체장','조례','주민 청원','주민 투표','주민 소환'],
    explain: {
      q1: '지방자치는 지역 주민들이 자신이 사는 지역의 문제를 직접 결정하고 해결해 나가는 제도예요.',
      q2: '지방자치를 실현하는 기관으로는 지방의회와 지방자치단체장이 있어요.',
    ...
    detail: {
      q1: '정답: ②번. 1문단에서 "지방자치는 지역 주민들이 자신이 사는 지역의 문제를 직접 결정하고 해결해 나가는 제도"라고 설명합니다. ①중앙 정부 결정 아님, ③국회의원만 아님, ④대통령 임명 아님.',
  ...
  on_pol_08: {
    ...
    essayKeywords: ['기본권','자유권','평등권','사회권','참정권','청구권','의무','납세','국방','교육','근로'],
    explain: {
    ...
    detail: {
      q1: '정답: ③번. 1문단에서 "헌법은 모든 국민이 태어날 때부터 가지는 기본권을 보장하며, 자유권, 평등권, 사회권, 참정권, 청구권 등이 있다"고 설명합니다. ①②④모두 오답.',
  ...
  on_pol_09: {
    ...
    essayKeywords: ['국제기구','국제연합','UN','WTO','WHO','ODA','유네스코','외교','국제법'],
    explain: {
      q1: 'UN은 전쟁을 예방하고 분쟁을 해결하며, 인권 보호와 경제 발전을 위해 노력해요.',
      q2: 'UN은 전쟁을 예방하고 분쟁을 해결하며, 인권 보호와 경제 발전을 위해 노력해요. 또한 세계무역기구(WTO), 세계보건기구(WHO) 등이 있습니다. 대한민국은 공적개발원조(ODA)를 제공하고 있어요.',
    ...
    detail: {
      q1: '정답: ④번. 2문단에서 "UN은 전쟁을 예방하고 분쟁을 해결하며, 인권 보호와 경제 발전을 위해 노력한다"고 설명합니다. ①WTO, ②특정 지역 아님, ③국내 문제 아님.',
  ...
  on_pol_10: {
    ...
    detail: {
      q1: '정답: ①번. 본문에서 "다름을 인정하면서도 평화롭게 공존하고 점진적으로 통합해 나가는 자세가 필요합니다"라고 설명하고 있습니다. 통일은 급하게 하나의 정부를 만드는 것이 아니라, 서로를 이해하고 존중하며 하나의 공동체로 통합해 가는 과정입니다.',
  ...
  on_pol_11: {
    ...
    essayKeywords: ['희소성','선택','기회비용','합리적','편익','비용','신중'],
    explain: {
      ...
      q3: '희소성 — 원하는 것은 무한하지만 자원은 한정되어 있는 상태 / 기회비용 — 어떤 선택을 할 때 포기한 것 중 가장 가치 있는 것',
      q4: '충동적으로 결정하기보다 신중하게 생각하는 습관을 기르면, 한정된 자원을 더 효율적으로 사용하고 후회 없는 결정을 할 수 있어요.',
      q5: '예시 답안: 희소성 때문에 우리는 항상 선택을 해야 합니다. 합리적 선택을 하려면 편익이 비용보다 큰지 따져 보고, 신중하게 결정해야 합니다.'
    },
    detail: {
      q1: '정답: ②번. 본문에서 "희소성이란 원하는 것은 무한하지만 자원은 한정되어 있다는 것을 의미합니다"라고 설명하고 있습니다. 희소성은 자원의 부족 상태를 말합니다.',
  ...
  on_pol_12: {
    ...
    essayKeywords: ['수요','공급','가격','균형','수요량','공급량','시장'],
    explain: {
      q1: '가격이 오르면 수요량은 줄어들고, 가격이 내리면 수요량은 늘어나요. 이것을 수요 법칙이라고 해요.',
      q2: '우리 주변에는 다양한 시장이 있어요. 시장에서는 수요와 공급이 만나요.',
      q3: '수요 — 물건이나 서비스를 사려고 하는 욕구 / 공급 — 생산자가 물건이나 서비스를 팔려고 내놓는 것',
    ...
    detail: {
      q1: '정답: ③번. 본문에서 "가격이 오르면 수요량은 줄어들고, 가격이 내리면 수요량은 늘어나요. 이것을 수요 법칙이라고 해요"라고 설명하고 있습니다.',
  ...
  on_pol_13: {
    ...
    answerKey: { q1:'4', q2:'2', q3:'2', q4:'3' },
    essayKeywords: ['균형','가격','수요','공급','신호','상한제','하한제','정부'],
    explain: {
      q1: '수요가 많고 공급이 적으면 가격이 오르고, 수요가 적고 공급이 많으면 가격이 내려요. 이렇게 정해진 가격을 균형 가격이라고 해요.',
      q2: '가격은 시장에서 중요한 신호 역할을 해요. 이처럼 가격은 행동을 조절하는 가격의 신호 기능을 해요.',
      q3: '균형 가격 — 수요와 공급이 일치할 때 형성되는 가격 / 신호 기능 — 가격 변화가 생산자와 소비자의 행동을 유도하는 역할',
    ...
    detail: {
      q1: '정답: ④번. 본문에서 "수요가 많고 공급이 적으면 가격이 오르고, 수요가 적고 공급이 많으면 가격이 내려요. 이렇게 정해진 가격을 균형 가격이라고 해요"라고 설명하고 있습니다.',
  ...
  on_pol_14: {
    ...
    essayKeywords: ['화폐','금융','저축','이자','투자','교환','가치','현명'],
    explain: {
      q1: '돈은 물건을 사고파는 교환의 수단, 가치를 나타내는 가치의 척도, 나중에 쓰기 위해 모아두는 가치의 저장 역할을 해요.',
      q2: '은행 외에도 증권 회사, 보험 회사 같은 금융 기관이 있어서 사람들이 돈을 투자하거나 미래에 대비할 수 있게 도와줘요.',
      q3: '금융 — 돈의 대출, 예금, 투자 등 돈과 관련된 모든 활동 / 저축 — 나중에 쓰기 위해 돈을 모아두는 것',
      q4: '돈의 흐름을 이해하고 현명하게 관리하는 능력을 길러야 합니다.',
      q5: '예시 답안: 돈은 교환의 수단, 가치의 척도, 가치의 저장 역할을 합니다. 저축을 하면 이자를 받아 돈을 불릴 수 있고, 투자를 통해 더 많이 불릴 수도 있습니다.'
    },
    detail: {
      q1: '정답: ①번. 본문에서 돈의 역할로 "교환의 수단, 가치의 척도, 가치의 저장"을 언급했습니다. "무기 역할"은 돈의 역할이 아닙니다.',
  ...
  on_pol_15: {
    ...
    essayKeywords: ['신용','합리적','소비','연체','충동','착한','계획적','예산'],
    explain: {
      q1: '신용은 "믿음"이라는 뜻으로, 약속을 잘 지키면 신용이 좋아지고, 약속을 어기면 신용이 나빠져요.',
      q2: '환경을 생각하여 꼭 필요한 만큼만 사는 착한 소비도 점점 중요해지고 있어요. 현명한 소비 습관은 미래의 경제적 자유를 위한 첫걸음이에요.',
      q3: '신용 — 약속을 지킬 것이라는 믿음 / 연체 — 빚을 약속한 기한 안에 갚지 못하는 것',
    ...
    detail: {
      q1: '정답: ②번. 본문에서 "신용은 \'믿음\'이라는 뜻으로, 약속을 잘 지키면 신용이 좋아지고, 약속을 어기면 신용이 나빠져요"라고 설명하고 있습니다.',
  ...
  on_pol_16: {
    ...
    answerKey: { q1:'3', q2:'1', q3:'2', q4:'3' },
    essayKeywords: ['기업','이윤','생산','사회적','책임','윤리','경영','환경'],
    explain: {
      q1: '하지만 기업이 이윤만 추구하면 환경 오염이나 소비자 피해 같은 문제가 생길 수 있어요.',
      q2: '기업은 물건이나 서비스를 만들어 팔고 이윤을 얻는 조직이에요.',
      q3: '이윤 — 기업이 물건을 팔아 얻는 이익, 수입에서 비용을 뺀 금액 / 소득 — 일을 해서 벌어들이는 돈',
      q4: '기업의 사회적 책임이란 이윤을 추구하면서도 환경을 보호하고, 직원을 존중하며, 지역 사회에 도움을 주는 것이에요.',
      q5: '예시 답안: 기업은 물건을 만들어 팔고 이윤을 얻으며, 일자리를 만들고 세금을 냅니다. 하지만 이윤만 추구하지 않고 환경 보호와 사회적 책임도 다해야 합니다.'
    },
    detail: {
      q1: '정답: ③번. 본문에서 "기업이 이윤만 추구하면 환경 오염이나 소비자 피해 같은 문제가 생길 수 있어요"라고 했습니다. 환경 오염을 어쩔 수 없다고 하는 것은 옳지 않습니다.',
  ...
  on_pol_17: {
    ...
    essayKeywords: ['GDP','경제','성장','호황','불황','인플레이션','실업','금리'],
    explain: {
      q1: 'GDP는 한 나라 안에서 일정 기간 동안 만들어진 모든 상품과 서비스의 가치를 합한 것이에요.',
      q2: '경제에는 좋아졌다 나빠졌다 하는 흐름이 있어요. 이것을 경기 변동이라고 해요. 물가가 계속 오르는 것을 인플레이션이라고 해요.',
      q3: '호황 — 경기가 좋아 기업과 일자리가 활발한 상태 / 불황 — 경기가 나빠 기업이 어렵고 일자리가 줄어든 상태',
      q4: '정부는 경제를 안정시키기 위해 노력해요. 중앙은행은 금리를 조절해서 경제를 관리해요.',
      q5: '예시 답안: GDP가 늘어나면 경제 성장이 일어납니다. 경기가 좋을 때는 호황, 나쁠 때는 불황이라 하며, 정부와 중앙은행은 금리 조절 등으로 경제 안정을 위해 노력합니다.'
    },
    detail: {
      q1: '정답: ④번. 본문에서 "GDP는 한 나라 안에서 일정 기간 동안 만들어진 모든 상품과 서비스의 가치를 합한 것이에요"라고 설명하고 있습니다.',
  ...
  on_pol_18: {
    ...
    essayKeywords: ['세금','정부','소득세','부가가치세','공공재','복지','예산','누진세'],
    explain: {
      q1: '세금은 국민이 나라에 내는 돈으로, 정부는 이 돈을 모아 공공 서비스에 사용해요.',
      q2: '정부는 세금으로 여러 가지 일을 해요. 공공재를 제공하고, 가난한 사람을 돕는 복지 정책을 펴요.',
      q3: '소득세 — 돈을 벌었을 때 내는 세금 / 부가가치세 — 물건을 살 때 가격에 포함되어 내는 세금',
      q4: '정부가 모든 국민에게 제공하는 서비스나 시설을 공공재라 하고, 국민의 생활을 돕는 정부의 정책이나 제도를 복지라고 해요.',
      q5: '예시 답안: 세금은 국민이 나라에 내는 돈으로, 정부는 이 돈으로 학교, 도로, 복지 등 공공 서비스를 제공합니다. 정부가 세금을 올바르게 사용하는지 관심을 갖는 것이 민주 시민의 자세입니다.'
    },
    detail: {
      q1: '정답: ①번. 본문에서 "세금은 국민이 나라에 내는 돈으로, 정부는 이 돈을 모아 공공 서비스에 사용해요"라고 설명하고 있습니다.',
  ...
  on_pol_19: {
    ...
    essayKeywords: ['무역','수출','수입','관세','FTA','세계화','상호','의존'],
    explain: {
      q1: '무역을 하면 모두에게 이익이 돼요. 각 나라가 잘 만드는 것에 집중하고 필요한 것을 교환해요.',
      q2: '우리나라는 무역 의존도가 높은 나라예요. 상호 의존하는 세계에서 협력하는 자세가 중요해요.',
      q3: '수출 — 우리나라에서 만든 물건을 외국에 파는 것 / 수입 — 외국에서 만든 물건을 우리나라로 사오는 것',
      q4: '관세 — 외국에서 들어오는 물건에 붙는 세금 / 세계화 — 세계 경제와 문화가 하나로 연결되는 현상',
      q5: '예시 답안: 무역을 하면 각 나라가 잘 만드는 것에 집중하고 필요한 것을 교환하여 모두에게 이익이 됩니다. 상호 의존하는 세계에서 협력하는 자세가 중요합니다.'
    },
    detail: {
      q1: '정답: ③번. 본문에서 "무역을 하면 모두에게 이익이 돼요"라고 설명하고 있습니다. 각 나라가 잘 만드는 것에 집중하고 필요한 것을 교환하면 효율적입니다.',
  ...
  on_pol_20: {
    ...
    essayKeywords: ['지속','가능','발전','환경','미래','세대','친환경','탄소'],
    explain: {
      q1: '지속 가능한 발전이란 지금 세대의 필요를 충족하면서도 미래 세대가 사용할 자원을 아끼고 환경을 보호하는 것이에요.',
      q2: '기술의 발전으로 인공지능(AI), 로봇, 빅데이터 같은 것들이 경제를 크게 바꾸고 있어요. 이런 변화를 4차 산업 혁명이라고 불러요.',
      q3: '4차 산업 혁명 — AI, 로봇, 빅데이터 등으로 일어나는 새로운 산업 변화 / 지속 가능한 발전 — 미래 세대도 쓸 수 있게 자원을 아끼며 발전하는 것',
      q4: '친환경 에너지 — 환경을 오염시키지 않는 태양광, 풍력 등의 에너지 / 탄소 중립 — 배출하는 탄소량과 흡수하는 양을 같게 만드는 것',
      q5: '예시 답안: 지속 가능한 발전을 위해 일회용품 사용을 줄이고, 대중교통을 이용하며, 재활용을 실천할 수 있습니다. 경제와 환경이 함께 발전하는 미래를 만드는 것은 우리 모두의 책임입니다.'
    },
    detail: {
      q1: '정답: ④번. 본문에서 "지속 가능한 발전이란 지금 세대의 필요를 충족하면서도 미래 세대가 사용할 자원을 아끼고 환경을 보호하는 것"이라고 설명하고 있습니다.',
