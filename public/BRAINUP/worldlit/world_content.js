...
window.CONTENTS = Object.assign(window.CONTENTS, {
  ...
  world_01: {
    ...
    passage: [
      ...
      '나는 용기를 내어 친구 민호에게 <b>고백하다</b> 마음먹었어요. "나, 사실 발표할 때 너무 떨려서 힘들어." 민호는 웃으며 말했어요. "나도 그래! 우리 같이 연습하자." 그 순간, 내 마음에 작은 <b>구원</b>의 빛이 들어왔어요. 두려움을 나누자 가벼워졌어요.',
    ...
    answerKey: { q1:'2', q2:'2', q3_1:['망설이다','망설임'], q3_2:['고백하다','고백'], q4_1:['우연히','우연'], q4_2:['극복하다','극복'] },
