...
(function () {
  ...
  if (window.CUR_UNIT && window.CUR_UNIT.startsWith('fit_world_')) {
  ...
  if (unitNum && unitNum >= 41 && unitNum <= 80) {
    ...
    window.CUR_UNIT = unitNum ? `world_${String(unitNum).padStart(2, '0')}` : 'fit_world_01';
...
function getCurrentUnit() {
  return (window.CUR_UNIT || 'fit_world_01');
}

window.renderVocabFill = function () {
  const unit = window.CUR_UNIT || 'fit_world_01';
...
window.gradeQuiz = function () {
  const pack = window.CONTENTS[window.CUR_UNIT] || window.CONTENTS.fit_world_01;
...
(function () {
  ...
  function detectUnit() {
    ...
    return (unitParam || (window.CUR_UNIT || 'fit_world_01')).toLowerCase();
  }
...
window.sendLearningLog = async function () {
  try {
    ...
    const unit = window.ORIGINAL_UNIT || window.CUR_UNIT || 'fit_world_02';
