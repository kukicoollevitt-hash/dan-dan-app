  ...
  (function () {
    ...
    function refreshReportTab() {
      try {
        const saved = localStorage.getItem('dan-geo-report-state');
        if (saved) {
