...
FILE_PATH = 'public/BRAINUP/person/deep_people2_content.js'

# 백업
backup_path = f"{FILE_PATH}.backup_simple_{int(datetime.now().timestamp())}"
...
# Unit 39 지표 확인
if 'deep_people2_39:' in content:
    print("✓ Unit 39 found")
else:
    print("✗ Unit 39 NOT found")
    exit(1)

if 'deep_people2_40:' in content:
    print("✓ Unit 40 found")
else:
    print("✗ Unit 40 NOT found")
    exit(1)

# Unit 39 passage 교체
# 구분자를 사용하여 정확하게 찾기
start_marker = "  deep_people2_39: {\n    labelNo: '39',\n    title: '🔭 지동설의 아버지, 갈릴레오 갈릴레이',\n    passage: ["
end_marker = "    ],\n    vocab: [\n      ['관찰',"

if start_marker in content and end_marker in content:
    # Unit 39 passage 부분 추출
...
"""
        ...
        # 기존 passage 내용 교체
        before_passage = content[:content.find(start_marker) + len(start_marker)]
        after_passage = content[start_idx + end_idx:]
        content = before_passage + new_passages + "\n" + end_marker + after_passage[after_passage.find(end_marker) + len(end_marker):]
        print("✓ Unit 39 passages 교체 완료")
    else:
        print("✗ Unit 39 end_marker를 찾을 수 없음")
else:
    print("✗ Unit 39 markers를 찾을 수 없음")
